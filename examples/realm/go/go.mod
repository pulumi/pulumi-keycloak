...
require (
	github.com/pulumi/pulumi-keycloak/sdk v0.0.0
	github.com/pulumi/pulumi/sdk/v3 v3.53.1
)

// Enables test to check in IDE, `go mod tidy.
//
// The examples test replaces this with an absolute path automatically.
replace github.com/pulumi/pulumi-keycloak/sdk => ../../../sdk
