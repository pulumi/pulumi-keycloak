...
namespace Pulumi.Keycloak.Oidc
{
    ...
    ///     });
    /// 
    ///     var microsoft = new Keycloak.Oidc.MicrosoftIdentityProvider("microsoft", new()
    ///     {
    ///         Realm = realm.Id,
    ...
    /// ```
    /// </summary>
    [KeycloakResourceType("keycloak:oidc/microsoftIdentityProvider:MicrosoftIdentityProvider")]
    public partial class MicrosoftIdentityProvider : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public MicrosoftIdentityProvider(string name, MicrosoftIdentityProviderArgs args, CustomResourceOptions? options = null)
            : base("keycloak:oidc/microsoftIdentityProvider:MicrosoftIdentityProvider", name, args ?? new MicrosoftIdentityProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MicrosoftIdentityProvider(string name, Input<string> id, MicrosoftIdentityProviderState? state = null, CustomResourceOptions? options = null)
            : base("keycloak:oidc/microsoftIdentityProvider:MicrosoftIdentityProvider", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MicrosoftIdentityProvider Get(string name, Input<string> id, MicrosoftIdentityProviderState? state = null, CustomResourceOptions? options = null)
        {
            return new MicrosoftIdentityProvider(name, id, state, options);
        }
    }

    public sealed class MicrosoftIdentityProviderArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When `True`, unauthenticated requests with `prompt=none` will be forwarded to Microsoft instead of returning an error. Defaults to `False`.
        /// </summary>
        ...
        public MicrosoftIdentityProviderArgs()
        {
        }
        public static new MicrosoftIdentityProviderArgs Empty => new MicrosoftIdentityProviderArgs();
    }

    public sealed class MicrosoftIdentityProviderState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When `True`, unauthenticated requests with `prompt=none` will be forwarded to Microsoft instead of returning an error. Defaults to `False`.
        /// </summary>
        ...
        public MicrosoftIdentityProviderState()
        {
        }
        public static new MicrosoftIdentityProviderState Empty => new MicrosoftIdentityProviderState();
    }
}
