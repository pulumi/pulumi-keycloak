...
namespace Pulumi.Keycloak.OpenId
{
    ...
    /// </summary>
    [KeycloakResourceType("keycloak:openid/clientAdminPermissions:ClientAdminPermissions")]
    public partial class ClientAdminPermissions : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ClientAdminPermissions(string name, ClientAdminPermissionsArgs args, CustomResourceOptions? options = null)
            : base("keycloak:openid/clientAdminPermissions:ClientAdminPermissions", name, args ?? new ClientAdminPermissionsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClientAdminPermissions(string name, Input<string> id, ClientAdminPermissionsState? state = null, CustomResourceOptions? options = null)
            : base("keycloak:openid/clientAdminPermissions:ClientAdminPermissions", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ClientAdminPermissions Get(string name, Input<string> id, ClientAdminPermissionsState? state = null, CustomResourceOptions? options = null)
        {
            return new ClientAdminPermissions(name, id, state, options);
        }
    }

    public sealed class ClientAdminPermissionsArgs : global::Pulumi.ResourceArgs
    {
        [Input("clientIds")]
        ...
        public ClientAdminPermissionsArgs()
        {
        }
        public static new ClientAdminPermissionsArgs Empty => new ClientAdminPermissionsArgs();
    }

    public sealed class ClientAdminPermissionsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the `admin-permissions` client, which acts as the resource server for these permissions.
        /// </summary>
        ...
        public ClientAdminPermissionsState()
        {
        }
        public static new ClientAdminPermissionsState Empty => new ClientAdminPermissionsState();
    }
}
