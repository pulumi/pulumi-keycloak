...
namespace Pulumi.Keycloak.OpenId
{
    public static partial class Invokes
    {
        public static Task<GetClientServiceAccountUserResult> GetClientServiceAccountUser(GetClientServiceAccountUserArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetClientServiceAccountUserResult>("keycloak:OpenId/getClientServiceAccountUser:getClientServiceAccountUser", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetClientServiceAccountUserArgs : Pulumi.ResourceArgs
    {
