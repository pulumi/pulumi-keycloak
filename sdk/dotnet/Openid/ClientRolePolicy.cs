...
namespace Pulumi.Keycloak.OpenId
{
    public partial class ClientRolePolicy : Pulumi.CustomResource
    {
        ...
        [Output("roles")]
        public Output<ImmutableArray<Outputs.ClientRolePolicyRoles>> Roles { get; private set; } = null!;
        ...
        public ClientRolePolicy(string name, ClientRolePolicyArgs args, CustomResourceOptions? options = null)
            : base("keycloak:openid/clientRolePolicy:ClientRolePolicy", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class ClientRolePolicyArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ClientRolePolicyRolesArgs>? _roles;
        public InputList<Inputs.ClientRolePolicyRolesArgs> Roles
        {
            get => _roles ?? (_roles = new InputList<Inputs.ClientRolePolicyRolesArgs>());
            set => _roles = value;
        }
    ...
    public sealed class ClientRolePolicyState : Pulumi.ResourceArgs
    {
        [Input("decisionStrategy")]
        public Input<string>? DecisionStrategy { get; set; }
        ...
        [Input("roles")]
        private InputList<Inputs.ClientRolePolicyRolesGetArgs>? _roles;
        public InputList<Inputs.ClientRolePolicyRolesGetArgs> Roles
        {
            get => _roles ?? (_roles = new InputList<Inputs.ClientRolePolicyRolesGetArgs>());
            set => _roles = value;
        }
    ...
    public sealed class ClientRolePolicyRolesArgs : Pulumi.ResourceArgs
    {
        ...
        public ClientRolePolicyRolesArgs()
        {
        }
    }

    public sealed class ClientRolePolicyRolesGetArgs : Pulumi.ResourceArgs
    {
        [Input("id", required: true)]
        public Input<string> Id { get; set; } = null!;
        ...
        public ClientRolePolicyRolesGetArgs()
        {
        }
    }
    }
    ...
    [OutputType]
    public sealed class ClientRolePolicyRoles
    {
        public readonly string Id;
        public readonly bool Required;

        [OutputConstructor]
        private ClientRolePolicyRoles(
            string id,
            bool required)
        {
            Id = id;
