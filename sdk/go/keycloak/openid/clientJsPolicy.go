...
// > **Note:** Consider `GenericClientAuthorizationPolicy` instead — it references deployed (and custom Java SPI) policy providers by `type` and does not suffer from the `code` drift described below.
//
...
//				Code:             pulumi.String("script-my-policy.js"),
//			})
//			if err != nil {
//				return err
//			}
