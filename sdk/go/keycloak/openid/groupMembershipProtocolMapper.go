...
// Indicates if the attribute should be added as a claim to the token introspection response. Defaults to `false`.
func (o GroupMembershipProtocolMapperOutput) AddToTokenIntrospection() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *GroupMembershipProtocolMapper) pulumi.BoolPtrOutput { return v.AddToTokenIntrospection }).(pulumi.BoolPtrOutput)
}
