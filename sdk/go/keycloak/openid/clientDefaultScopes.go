...
func (i *ClientDefaultScopes) ToOutput(ctx context.Context) pulumix.Output[*ClientDefaultScopes] {
	return pulumix.Output[*ClientDefaultScopes]{
		OutputState: i.ToClientDefaultScopesOutputWithContext(ctx).OutputState,
	}
}
...
func (i ClientDefaultScopesArray) ToOutput(ctx context.Context) pulumix.Output[[]*ClientDefaultScopes] {
	return pulumix.Output[[]*ClientDefaultScopes]{
		OutputState: i.ToClientDefaultScopesArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i ClientDefaultScopesMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*ClientDefaultScopes] {
	return pulumix.Output[map[string]*ClientDefaultScopes]{
		OutputState: i.ToClientDefaultScopesMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o ClientDefaultScopesOutput) ToOutput(ctx context.Context) pulumix.Output[*ClientDefaultScopes] {
	return pulumix.Output[*ClientDefaultScopes]{
...
func (o ClientDefaultScopesOutput) ClientId() pulumi.StringOutput {
	return o.ApplyT(func(v *ClientDefaultScopes) pulumi.StringOutput { return v.ClientId }).(pulumi.StringOutput)
}

// An array of client scope names to attach to this client.
func (o ClientDefaultScopesOutput) DefaultScopes() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *ClientDefaultScopes) pulumi.StringArrayOutput { return v.DefaultScopes }).(pulumi.StringArrayOutput)
}

// The realm this client and scopes exists in.
func (o ClientDefaultScopesOutput) RealmId() pulumi.StringOutput {
	return o.ApplyT(func(v *ClientDefaultScopes) pulumi.StringOutput { return v.RealmId }).(pulumi.StringOutput)
}
...
func (o ClientDefaultScopesArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*ClientDefaultScopes] {
	return pulumix.Output[[]*ClientDefaultScopes]{
		OutputState: o.OutputState,
	}
}
...
func (o ClientDefaultScopesMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*ClientDefaultScopes] {
	return pulumix.Output[map[string]*ClientDefaultScopes]{
		OutputState: o.OutputState,
	}
}
