...
func (i *ClientOptionalScopes) ToOutput(ctx context.Context) pulumix.Output[*ClientOptionalScopes] {
	return pulumix.Output[*ClientOptionalScopes]{
		OutputState: i.ToClientOptionalScopesOutputWithContext(ctx).OutputState,
	}
}
...
func (i ClientOptionalScopesArray) ToOutput(ctx context.Context) pulumix.Output[[]*ClientOptionalScopes] {
	return pulumix.Output[[]*ClientOptionalScopes]{
		OutputState: i.ToClientOptionalScopesArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i ClientOptionalScopesMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*ClientOptionalScopes] {
	return pulumix.Output[map[string]*ClientOptionalScopes]{
		OutputState: i.ToClientOptionalScopesMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o ClientOptionalScopesOutput) ToOutput(ctx context.Context) pulumix.Output[*ClientOptionalScopes] {
	return pulumix.Output[*ClientOptionalScopes]{
...
func (o ClientOptionalScopesArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*ClientOptionalScopes] {
	return pulumix.Output[[]*ClientOptionalScopes]{
		OutputState: o.OutputState,
	}
}
...
func (o ClientOptionalScopesMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*ClientOptionalScopes] {
	return pulumix.Output[map[string]*ClientOptionalScopes]{
		OutputState: o.OutputState,
	}
}
