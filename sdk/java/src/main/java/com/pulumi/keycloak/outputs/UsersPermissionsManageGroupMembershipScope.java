...
@CustomType
public final class UsersPermissionsManageGroupMembershipScope {
    private final @Nullable String decisionStrategy;
    private final @Nullable String description;
    private final @Nullable List<String> policies;

    @CustomType.Constructor
    private UsersPermissionsManageGroupMembershipScope(
    ...
    public static Builder builder(UsersPermissionsManageGroupMembershipScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(UsersPermissionsManageGroupMembershipScope defaults) {
        ...
        }        public UsersPermissionsManageGroupMembershipScope build() {
            return new UsersPermissionsManageGroupMembershipScope(decisionStrategy, description, policies);
        }
    }
}
