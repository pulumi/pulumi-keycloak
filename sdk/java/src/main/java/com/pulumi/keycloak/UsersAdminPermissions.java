...
import com.pulumi.keycloak.inputs.UsersAdminPermissionsState;
 ...
 * 
 */
@ResourceType(type="keycloak:index/usersAdminPermissions:UsersAdminPermissions")
public class UsersAdminPermissions extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public UsersAdminPermissions(java.lang.String name) {
        this(name, UsersAdminPermissionsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public UsersAdminPermissions(java.lang.String name, UsersAdminPermissionsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public UsersAdminPermissions(java.lang.String name, UsersAdminPermissionsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keycloak:index/usersAdminPermissions:UsersAdminPermissions", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private UsersAdminPermissions(java.lang.String name, Output<java.lang.String> id, @Nullable UsersAdminPermissionsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keycloak:index/usersAdminPermissions:UsersAdminPermissions", name, state, makeResourceOptions(options, id), false);
    }

    private static UsersAdminPermissionsArgs makeArgs(UsersAdminPermissionsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? UsersAdminPermissionsArgs.Empty : args;
    }
     ...
     */
    public static UsersAdminPermissions get(java.lang.String name, Output<java.lang.String> id, @Nullable UsersAdminPermissionsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
