...
@CustomType
public final class ClientPermissionsMapRolesClientScopeScope {
    private final @Nullable String decisionStrategy;
    private final @Nullable String description;
    private final @Nullable List<String> policies;

    @CustomType.Constructor
    private ClientPermissionsMapRolesClientScopeScope(
    ...
    public static Builder builder(ClientPermissionsMapRolesClientScopeScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ClientPermissionsMapRolesClientScopeScope defaults) {
        ...
        }        public ClientPermissionsMapRolesClientScopeScope build() {
            return new ClientPermissionsMapRolesClientScopeScope(decisionStrategy, description, policies);
        }
    }
}
