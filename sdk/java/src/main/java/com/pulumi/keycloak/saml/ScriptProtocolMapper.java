...
public class ScriptProtocolMapper extends com.pulumi.resources.CustomResource {
    ...
    public ScriptProtocolMapper(java.lang.String name, ScriptProtocolMapperArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keycloak:saml/scriptProtocolMapper:ScriptProtocolMapper", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ScriptProtocolMapper(java.lang.String name, Output<java.lang.String> id, @Nullable ScriptProtocolMapperState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keycloak:saml/scriptProtocolMapper:ScriptProtocolMapper", name, state, makeResourceOptions(options, id), false);
    }
