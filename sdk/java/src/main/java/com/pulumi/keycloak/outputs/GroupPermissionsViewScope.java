...
@CustomType
public final class GroupPermissionsViewScope {
    ...
    public static Builder builder(GroupPermissionsViewScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GroupPermissionsViewScope defaults) {
        ...
        }        public GroupPermissionsViewScope build() {
            return new GroupPermissionsViewScope(decisionStrategy, description, policies);
        }
    }
}
