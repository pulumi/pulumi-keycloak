...
@CustomType
public final class GroupPermissionsManageMembershipScope {
    ...
    public static Builder builder(GroupPermissionsManageMembershipScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GroupPermissionsManageMembershipScope defaults) {
        ...
        }        public GroupPermissionsManageMembershipScope build() {
            return new GroupPermissionsManageMembershipScope(decisionStrategy, description, policies);
        }
    }
}
