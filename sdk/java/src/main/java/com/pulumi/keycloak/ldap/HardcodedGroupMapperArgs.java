...
public final class HardcodedGroupMapperArgs extends com.pulumi.resources.ResourceArgs {

    public static final HardcodedGroupMapperArgs Empty = new HardcodedGroupMapperArgs();
    ...
    private HardcodedGroupMapperArgs() {}

    private HardcodedGroupMapperArgs(HardcodedGroupMapperArgs $) {
        this.group = $.group;
    ...
    public static Builder builder(HardcodedGroupMapperArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HardcodedGroupMapperArgs();
        }

        public Builder(HardcodedGroupMapperArgs defaults) {
            $ = new HardcodedGroupMapperArgs(Objects.requireNonNull(defaults));
        }
