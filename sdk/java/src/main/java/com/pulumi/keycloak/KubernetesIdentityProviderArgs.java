...
public final class KubernetesIdentityProviderArgs extends com.pulumi.resources.ResourceArgs {

    public static final KubernetesIdentityProviderArgs Empty = new KubernetesIdentityProviderArgs();
    ...
    private KubernetesIdentityProviderArgs() {}

    private KubernetesIdentityProviderArgs(KubernetesIdentityProviderArgs $) {
    ...
    public static Builder builder(KubernetesIdentityProviderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubernetesIdentityProviderArgs();
        }

        public Builder(KubernetesIdentityProviderArgs defaults) {
            $ = new KubernetesIdentityProviderArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KubernetesIdentityProviderArgs build() {
            if ($.alias == null) {
                throw new MissingRequiredPropertyException("KubernetesIdentityProviderArgs", "alias");
            }
            if ($.issuer == null) {
                throw new MissingRequiredPropertyException("KubernetesIdentityProviderArgs", "issuer");
            }
            if ($.realm == null) {
                throw new MissingRequiredPropertyException("KubernetesIdentityProviderArgs", "realm");
            }
            return $;
        }
    }
