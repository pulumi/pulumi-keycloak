...
public class UserGroups extends com.pulumi.resources.CustomResource {
    ...
    public UserGroups(java.lang.String name, UserGroupsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keycloak:index/userGroups:UserGroups", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private UserGroups(java.lang.String name, Output<java.lang.String> id, @Nullable UserGroupsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keycloak:index/userGroups:UserGroups", name, state, makeResourceOptions(options, id), false);
    }
