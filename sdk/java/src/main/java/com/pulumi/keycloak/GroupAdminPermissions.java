...
import com.pulumi.keycloak.inputs.GroupAdminPermissionsState;
 ...
 * 
 */
@ResourceType(type="keycloak:index/groupAdminPermissions:GroupAdminPermissions")
public class GroupAdminPermissions extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public GroupAdminPermissions(java.lang.String name) {
        this(name, GroupAdminPermissionsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GroupAdminPermissions(java.lang.String name, GroupAdminPermissionsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GroupAdminPermissions(java.lang.String name, GroupAdminPermissionsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keycloak:index/groupAdminPermissions:GroupAdminPermissions", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GroupAdminPermissions(java.lang.String name, Output<java.lang.String> id, @Nullable GroupAdminPermissionsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("keycloak:index/groupAdminPermissions:GroupAdminPermissions", name, state, makeResourceOptions(options, id), false);
    }

    private static GroupAdminPermissionsArgs makeArgs(GroupAdminPermissionsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GroupAdminPermissionsArgs.Empty : args;
    }
     ...
     */
    public static GroupAdminPermissions get(java.lang.String name, Output<java.lang.String> id, @Nullable GroupAdminPermissionsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
