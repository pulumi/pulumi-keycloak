...
public final class GetRealmWebAuthnPolicy extends com.pulumi.resources.InvokeArgs {

    public static final GetRealmWebAuthnPolicy Empty = new GetRealmWebAuthnPolicy();
    ...
    private GetRealmWebAuthnPolicy(GetRealmWebAuthnPolicy $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRealmWebAuthnPolicy();
        }

        public Builder(GetRealmWebAuthnPolicy defaults) {
            $ = new GetRealmWebAuthnPolicy(Objects.requireNonNull(defaults));
        }
