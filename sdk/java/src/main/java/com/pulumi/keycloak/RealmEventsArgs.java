...
public final class RealmEventsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RealmEventsArgs() {}

    private RealmEventsArgs(RealmEventsArgs $) {
    ...
    public static Builder builder(RealmEventsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RealmEventsArgs defaults) {
        ...
        public RealmEventsArgs build() {
            if ($.realmId == null) {
                throw new MissingRequiredPropertyException("RealmEventsArgs", "realmId");
            }
            return $;
        }
    }
