...
public final class MicrosoftIdentityProviderArgs extends com.pulumi.resources.ResourceArgs {

    public static final MicrosoftIdentityProviderArgs Empty = new MicrosoftIdentityProviderArgs();
    ...
    private MicrosoftIdentityProviderArgs() {}

    private MicrosoftIdentityProviderArgs(MicrosoftIdentityProviderArgs $) {
    ...
    public static Builder builder(MicrosoftIdentityProviderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MicrosoftIdentityProviderArgs();
        }

        public Builder(MicrosoftIdentityProviderArgs defaults) {
            $ = new MicrosoftIdentityProviderArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param acceptsPromptNoneForwardFromClient When `true`, unauthenticated requests with `prompt=none` will be forwarded to Microsoft instead of returning an error. Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param alias The alias for the Microsoft identity provider.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param displayName Display name for the Microsoft identity provider in the GUI.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param prompt Indicates the type of user interaction that is required. The only valid values at this time are `login`, `none`, `consent`, and `selectAccount`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param providerId The ID of the identity provider to use. Defaults to `microsoft`, which should be used unless you have extended Keycloak and provided your own implementation.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tenantId Uses single-tenant auth endpoints when specified, uses `common`&#39; multi-tenant endpoints otherwise.
         * 
         * @return builder
         * 
         */
        ...
        public MicrosoftIdentityProviderArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("MicrosoftIdentityProviderArgs", "clientId");
            }
            if ($.clientSecret == null) {
                throw new MissingRequiredPropertyException("MicrosoftIdentityProviderArgs", "clientSecret");
            }
            if ($.realm == null) {
                throw new MissingRequiredPropertyException("MicrosoftIdentityProviderArgs", "realm");
            }
            return $;
        }
    }
