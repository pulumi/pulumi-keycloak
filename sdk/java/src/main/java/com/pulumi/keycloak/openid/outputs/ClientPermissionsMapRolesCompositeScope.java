...
@CustomType
public final class ClientPermissionsMapRolesCompositeScope {
    ...
    public static Builder builder(ClientPermissionsMapRolesCompositeScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ClientPermissionsMapRolesCompositeScope defaults) {
        ...
        }        public ClientPermissionsMapRolesCompositeScope build() {
            return new ClientPermissionsMapRolesCompositeScope(decisionStrategy, description, policies);
        }
    }
}
