...
public final class GroupPermissionsManageMembersScope {
    ...
    public static Builder builder(GroupPermissionsManageMembersScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GroupPermissionsManageMembersScope defaults) {
        ...
        }        public GroupPermissionsManageMembersScope build() {
            return new GroupPermissionsManageMembersScope(decisionStrategy, description, policies);
        }
    }
}
