...
public final class RealmWebAuthnPasswordlessPolicy {
    ...
    public static final class Builder {
        ...
        public Builder userVerificationRequirement(@Nullable String userVerificationRequirement) {
            ...
            return new RealmWebAuthnPasswordlessPolicy(acceptableAaguids, attestationConveyancePreference, authenticatorAttachment, avoidSameAuthenticatorRegister, createTimeout, relyingPartyEntityName, relyingPartyId, requireResidentKey, signatureAlgorithms, userVerificationRequirement);
        }
    }
}
