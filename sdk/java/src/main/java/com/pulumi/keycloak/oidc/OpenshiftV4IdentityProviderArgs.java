...
public final class OpenshiftV4IdentityProviderArgs extends com.pulumi.resources.ResourceArgs {

    public static final OpenshiftV4IdentityProviderArgs Empty = new OpenshiftV4IdentityProviderArgs();
    ...
    private OpenshiftV4IdentityProviderArgs() {}

    private OpenshiftV4IdentityProviderArgs(OpenshiftV4IdentityProviderArgs $) {
    ...
    public static Builder builder(OpenshiftV4IdentityProviderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OpenshiftV4IdentityProviderArgs();
        }

        public Builder(OpenshiftV4IdentityProviderArgs defaults) {
            $ = new OpenshiftV4IdentityProviderArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param alias The alias for the OpenShift v4 identity provider. Defaults to `openshift-v4`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param baseUrl Base URL of the OpenShift 4 cluster, e.g. `https://openshift.example.com:8443`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param defaultScopes The scopes to be sent when asking for authorization. Defaults to `user:full`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param displayName Display name for the OpenShift v4 identity provider in the GUI.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param providerId The ID of the identity provider to use. Defaults to `openshift-v4`, which should be used unless you have extended Keycloak and provided your own implementation.
         * 
         * @return builder
         * 
         */
        ...
        public OpenshiftV4IdentityProviderArgs build() {
            if ($.baseUrl == null) {
                throw new MissingRequiredPropertyException("OpenshiftV4IdentityProviderArgs", "baseUrl");
            }
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("OpenshiftV4IdentityProviderArgs", "clientId");
            }
            if ($.clientSecret == null) {
                throw new MissingRequiredPropertyException("OpenshiftV4IdentityProviderArgs", "clientSecret");
            }
            if ($.realm == null) {
                throw new MissingRequiredPropertyException("OpenshiftV4IdentityProviderArgs", "realm");
            }
            return $;
        }
    }
