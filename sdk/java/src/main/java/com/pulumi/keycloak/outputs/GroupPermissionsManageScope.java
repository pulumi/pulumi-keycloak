...
public final class GroupPermissionsManageScope {
    ...
    public static Builder builder(GroupPermissionsManageScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GroupPermissionsManageScope defaults) {
        ...
        }        public GroupPermissionsManageScope build() {
            return new GroupPermissionsManageScope(decisionStrategy, description, policies);
        }
    }
}
