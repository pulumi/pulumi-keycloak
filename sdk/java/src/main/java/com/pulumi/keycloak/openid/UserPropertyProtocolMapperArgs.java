...
public final class UserPropertyProtocolMapperArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param clientScopeId The client scope this protocol mapper should be attached to. Conflicts with `clientId`. One of `clientId` or `clientScopeId` must be specified. `clientScopeId` - (Required if `clientId` is not specified) The client scope this protocol mapper is attached to.
         * 
         * @return builder
         * 
         */
        ...
        public UserPropertyProtocolMapperArgs build() {
            if ($.claimName == null) {
                throw new MissingRequiredPropertyException("UserPropertyProtocolMapperArgs", "claimName");
            }
            if ($.realmId == null) {
