...
@CustomType
public final class UsersPermissionsUserImpersonatedScope {
    private final @Nullable String decisionStrategy;
    private final @Nullable String description;
    private final @Nullable List<String> policies;

    @CustomType.Constructor
    private UsersPermissionsUserImpersonatedScope(
    ...
    public static Builder builder(UsersPermissionsUserImpersonatedScope defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(UsersPermissionsUserImpersonatedScope defaults) {
        ...
        }        public UsersPermissionsUserImpersonatedScope build() {
            return new UsersPermissionsUserImpersonatedScope(decisionStrategy, description, policies);
        }
    }
}
