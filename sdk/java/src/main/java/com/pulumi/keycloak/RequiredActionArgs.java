...
public final class RequiredActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final RequiredActionArgs Empty = new RequiredActionArgs();
    ...
    public static Builder builder(RequiredActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RequiredActionArgs();
        }

        public Builder(RequiredActionArgs defaults) {
            $ = new RequiredActionArgs(Objects.requireNonNull(defaults));
        }
