...
class RealmKeystoreEcdsaGeneratedArgs:
    def __init__(__self__, *,
                 ...
                 elliptic_curve_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] elliptic_curve_key: Elliptic Curve used in ECDSA. Defaults to `P-256`.
    ...
    def elliptic_curve_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def elliptic_curve_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RealmKeystoreEcdsaGenerated(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            priority: Optional[pulumi.Input[builtins.int]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RealmKeystoreEcdsaGenerated':
        """
    ...
    @property
    @pulumi.getter(name="ellipticCurveKey")
    def elliptic_curve_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Elliptic Curve used in ECDSA. Defaults to `P-256`.
        """
        return pulumi.get(self, "elliptic_curve_key")
