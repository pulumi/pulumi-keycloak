...
class GetUserResult:
    ...
    def federated_identities(self) -> Sequence[_builtins.str]:
        """
    ...
    def required_actions(self) -> Sequence[_builtins.str]:
...
def get_user(realm_id: Optional[_builtins.str] = None,
...
def get_user_output(realm_id: Optional[pulumi.Input[_builtins.str]] = None,
