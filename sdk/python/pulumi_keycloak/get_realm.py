...
class GetRealmResult:
    ...
    def default_default_client_scopes(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "default_default_client_scopes")

    @property
    @pulumi.getter(name="defaultOptionalClientScopes")
    def default_optional_client_scopes(self) -> Sequence[builtins.str]:
    ...
    def display_name_html(self) -> Optional[builtins.str]:
    ...
    def duplicate_emails_allowed(self) -> builtins.bool:
        return pulumi.get(self, "duplicate_emails_allowed")

    @property
    @pulumi.getter(name="editUsernameAllowed")
    def edit_username_allowed(self) -> builtins.bool:
    ...
    def login_with_email_allowed(self) -> builtins.bool:
    ...
    def oauth2_device_polling_interval(self) -> builtins.int:
    ...
    def remember_me(self) -> builtins.bool:
    ...
    def reset_password_allowed(self) -> builtins.bool:
        return pulumi.get(self, "reset_password_allowed")

    @property
    @pulumi.getter(name="revokeRefreshToken")
    def revoke_refresh_token(self) -> builtins.bool:
    ...
    def user_managed_access(self) -> builtins.bool:
        return pulumi.get(self, "user_managed_access")

    @property
    @pulumi.getter(name="verifyEmail")
    def verify_email(self) -> builtins.bool:
...
def get_realm(attributes: Optional[Mapping[str, builtins.str]] = None,
              default_default_client_scopes: Optional[Sequence[builtins.str]] = None,
              default_optional_client_scopes: Optional[Sequence[builtins.str]] = None,
              display_name_html: Optional[builtins.str] = None,
    ...
    :param builtins.str realm: The realm name.
    """
    __args__ = dict()
...
def get_realm_output(attributes: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
                     default_default_client_scopes: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                     default_optional_client_scopes: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                     display_name_html: Optional[pulumi.Input[Optional[builtins.str]]] = None,
