...
class GetRealmResult:
    ...
    def admin_theme(self) -> _builtins.str:
    ...
    def first_broker_login_flow(self) -> _builtins.str:
...
def get_realm(attributes: Optional[Mapping[str, _builtins.str]] = None,
              default_default_client_scopes: Optional[Sequence[_builtins.str]] = None,
              default_optional_client_scopes: Optional[Sequence[_builtins.str]] = None,
              display_name_html: Optional[_builtins.str] = None,
              internationalizations: Optional[Sequence[Union['GetRealmInternationalizationArgs', 'GetRealmInternationalizationArgsDict', 'outputs.GetRealmInternationalizationResult']]] = None,
              otp_policy: Optional[Union['GetRealmOtpPolicyArgs', 'GetRealmOtpPolicyArgsDict', 'outputs.GetRealmOtpPolicyResult']] = None,
              realm: Optional[_builtins.str] = None,
              security_defenses: Optional[Sequence[Union['GetRealmSecurityDefenseArgs', 'GetRealmSecurityDefenseArgsDict', 'outputs.GetRealmSecurityDefenseResult']]] = None,
              smtp_servers: Optional[Sequence[Union['GetRealmSmtpServerArgs', 'GetRealmSmtpServerArgsDict', 'outputs.GetRealmSmtpServerResult']]] = None,
              web_authn_passwordless_policy: Optional[Union['GetRealmWebAuthnPasswordlessPolicyArgs', 'GetRealmWebAuthnPasswordlessPolicyArgsDict', 'outputs.GetRealmWebAuthnPasswordlessPolicyResult']] = None,
              web_authn_policy: Optional[Union['GetRealmWebAuthnPolicyArgs', 'GetRealmWebAuthnPolicyArgsDict', 'outputs.GetRealmWebAuthnPolicyResult']] = None,
    ...
    :param _builtins.str realm: The realm name.
    """
    __args__ = dict()
...
def get_realm_output(attributes: pulumi.Input[Optional[Optional[Mapping[str, _builtins.str]]]] = None,
                     default_default_client_scopes: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                     default_optional_client_scopes: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                     display_name_html: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     internationalizations: pulumi.Input[Optional[Optional[Sequence[Union['GetRealmInternationalizationArgs', 'GetRealmInternationalizationArgsDict', 'outputs.GetRealmInternationalizationResult']]]]] = None,
                     otp_policy: pulumi.Input[Optional[Optional[Union['GetRealmOtpPolicyArgs', 'GetRealmOtpPolicyArgsDict', 'outputs.GetRealmOtpPolicyResult']]]] = None,
                     realm: pulumi.Input[Optional[_builtins.str]] = None,
                     security_defenses: pulumi.Input[Optional[Optional[Sequence[Union['GetRealmSecurityDefenseArgs', 'GetRealmSecurityDefenseArgsDict', 'outputs.GetRealmSecurityDefenseResult']]]]] = None,
                     smtp_servers: pulumi.Input[Optional[Optional[Sequence[Union['GetRealmSmtpServerArgs', 'GetRealmSmtpServerArgsDict', 'outputs.GetRealmSmtpServerResult']]]]] = None,
                     web_authn_passwordless_policy: pulumi.Input[Optional[Optional[Union['GetRealmWebAuthnPasswordlessPolicyArgs', 'GetRealmWebAuthnPasswordlessPolicyArgsDict', 'outputs.GetRealmWebAuthnPasswordlessPolicyResult']]]] = None,
                     web_authn_policy: pulumi.Input[Optional[Optional[Union['GetRealmWebAuthnPolicyArgs', 'GetRealmWebAuthnPolicyArgsDict', 'outputs.GetRealmWebAuthnPolicyResult']]]] = None,
