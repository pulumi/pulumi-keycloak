...
class GenericClientProtocolMapperArgs:
    def __init__(__self__, *,
                 ...
                 protocol_mapper: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] client_id: The client this protocol mapper is attached to.
        :param pulumi.Input[_builtins.str] client_scope_id: The mapper's associated client scope. Cannot be used at the same time as client_id.
    ...
    def protocol_mapper(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def protocol_mapper(self, value: pulumi.Input[_builtins.str]):
...
class _GenericClientProtocolMapperState:
    def __init__(__self__, *,
                 ...
                 protocol_mapper: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="protocolMapper")
    def protocol_mapper(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The name of the protocol mapper. The protocol mapper must be compatible with the specified client.
        """
        return pulumi.get(self, "protocol_mapper")
    ...
    @protocol_mapper.setter
    def protocol_mapper(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "protocol_mapper", value)
...
class GenericClientProtocolMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocol: Optional[pulumi.Input[_builtins.str]] = None,
            protocol_mapper: Optional[pulumi.Input[_builtins.str]] = None,
            realm_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'GenericClientProtocolMapper':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="protocolMapper")
    def protocol_mapper(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the protocol mapper. The protocol mapper must be compatible with the specified client.
        """
        return pulumi.get(self, "protocol_mapper")
