...
class UserTemplateImporterIdentityProviderMapper(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, extra_config=None, identity_provider_alias=None, name=None, realm=None, template=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, extra_config=None, identity_provider_alias=None, name=None, realm=None, template=None):
        """
