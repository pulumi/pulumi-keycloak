...
class UserSessionNoteProtocolMapperArgs:
    def __init__(__self__, *,
                 ...
                 session_note: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] session_note: String value being the name of stored user session note within the `UserSessionModel.note` map.
        """
    ...
    def session_note(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @session_note.setter
    def session_note(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class UserSessionNoteProtocolMapper(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        $ pulumi import keycloak:openid/userSessionNoteProtocolMapper:UserSessionNoteProtocolMapper user_session_note_mapper my-realm/client/a7202154-8793-4656-b655-1dd18c181e14/name/my%20protocol%20mapper
        $ pulumi import keycloak:openid/userSessionNoteProtocolMapper:UserSessionNoteProtocolMapper user_session_note_mapper my-realm/client-scope/b799ea7e-73ee-4a73-990a-1eafebe8e20a/name/my%20protocol%20mapper
        ```
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            realm_id: pulumi.Input[Optional[_builtins.str]] = None,
            session_note: pulumi.Input[Optional[_builtins.str]] = None) -> 'UserSessionNoteProtocolMapper':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sessionNote")
    def session_note(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        String value being the name of stored user session note within the `UserSessionModel.note` map.
        """
        return pulumi.get(self, "session_note")
