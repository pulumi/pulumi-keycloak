...
class ClientGroupPolicy(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name, id, opts=None, decision_strategy=None, description=None, groups=None, groups_claim=None, logic=None, name=None, realm_id=None, resource_server_id=None):
        """
