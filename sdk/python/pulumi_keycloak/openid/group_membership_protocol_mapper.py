...
class GroupMembershipProtocolMapperArgs:
    def __init__(__self__, *,
                 ...
                 full_path: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] full_path: Indicates whether the full path of the group including its parents will be used. Defaults to `true`.
    ...
    def full_path(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @full_path.setter
    def full_path(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("keycloak:openid/groupMembershipProtocolMapper:GroupMembershipProtocolMapper")
class GroupMembershipProtocolMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            full_path: Optional[pulumi.Input[builtins.bool]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'GroupMembershipProtocolMapper':
        """
    ...
    @property
    @pulumi.getter(name="fullPath")
    def full_path(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the full path of the group including its parents will be used. Defaults to `true`.
        """
        return pulumi.get(self, "full_path")
