...
def get_client_service_account_user(client_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str client_id: The ID of the OpenID client with service accounts enabled.
    :param _builtins.str realm_id: The realm that the OpenID client exists within.
    """
    __args__ = dict()
