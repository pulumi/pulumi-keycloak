...
class ClientScopeArgs:
    def __init__(__self__, *,
                 ...
                 gui_order: Optional[pulumi.Input[builtins.int]] = None,
                 include_in_token_scope: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ClientScope resource.
        :param pulumi.Input[builtins.str] realm_id: The realm this client scope belongs to.
        :param pulumi.Input[builtins.str] consent_screen_text: When set, a consent screen will be displayed to users authenticating to clients with this scope attached. The consent screen will display the string value of this attribute.
        :param pulumi.Input[builtins.str] description: The description of this client scope in the GUI.
        :param pulumi.Input[builtins.int] gui_order: Specify order of the client scope in GUI (such as in Consent page) as integer.
        :param pulumi.Input[builtins.bool] include_in_token_scope: When `true`, the name of this client scope will be added to the access token property 'scope' as well as to the Token Introspection Endpoint response.
        :param pulumi.Input[builtins.str] name: The display name of this client scope in the GUI.
        """
    ...
    def gui_order(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @gui_order.setter
    def gui_order(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "gui_order", value)

    @property
    @pulumi.getter(name="includeInTokenScope")
    def include_in_token_scope(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def include_in_token_scope(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("keycloak:openid/clientScope:ClientScope")
class ClientScope(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            include_in_token_scope: Optional[pulumi.Input[builtins.bool]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientScope':
        """
    ...
    @property
    @pulumi.getter(name="consentScreenText")
    def consent_screen_text(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When set, a consent screen will be displayed to users authenticating to clients with this scope attached. The consent screen will display the string value of this attribute.
        """
        return pulumi.get(self, "consent_screen_text")
    ...
    @property
    @pulumi.getter(name="guiOrder")
    def gui_order(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specify order of the client scope in GUI (such as in Consent page) as integer.
        """
        return pulumi.get(self, "gui_order")
    ...
    @property
    @pulumi.getter(name="includeInTokenScope")
    def include_in_token_scope(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, the name of this client scope will be added to the access token property 'scope' as well as to the Token Introspection Endpoint response.
        """
        return pulumi.get(self, "include_in_token_scope")
