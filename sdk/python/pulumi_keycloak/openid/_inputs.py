...
class ClientAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] decision_strategy: Dictates how the policies associated with a given permission are evaluated and how a final decision is obtained. Could be one of `AFFIRMATIVE`, `CONSENSUS`, or `UNANIMOUS`. Applies to permissions.
        :param pulumi.Input[_builtins.bool] keep_defaults: When `true`, defaults set by Keycloak will be respected. Defaults to `false`.
        """
    ...
    def policy_enforcement_mode(self) -> pulumi.Input[_builtins.str]:
        """
        Dictates how policies are enforced when evaluating authorization requests. Can be one of `ENFORCING`, `PERMISSIVE`, or `DISABLED`.
        """
    ...
    def policy_enforcement_mode(self, value: pulumi.Input[_builtins.str]):
...
class ClientGroupPolicyGroupArgs:
    ...
    def extend_children(self) -> pulumi.Input[_builtins.bool]:
        return pulumi.get(self, "extend_children")

    @extend_children.setter
    def extend_children(self, value: pulumi.Input[_builtins.bool]):
