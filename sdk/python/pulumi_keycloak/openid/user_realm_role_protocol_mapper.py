...
class UserRealmRoleProtocolMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] add_to_token_introspection: Indicates if the property should be added as a claim to the Token Introspection response body. Defaults to `true`.
        ...
        :param pulumi.Input[_builtins.str] realm_role_prefix: A prefix for each Realm Role.
        """
...
class UserRealmRoleProtocolMapper(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        $ pulumi import keycloak:openid/userRealmRoleProtocolMapper:UserRealmRoleProtocolMapper user_realm_role_mapper my-realm/client/a7202154-8793-4656-b655-1dd18c181e14/name/my%20protocol%20mapper
        $ pulumi import keycloak:openid/userRealmRoleProtocolMapper:UserRealmRoleProtocolMapper user_realm_role_mapper my-realm/client-scope/b799ea7e-73ee-4a73-990a-1eafebe8e20a/name/my%20protocol%20mapper
        ```
    ...
    @_builtins.property
    @pulumi.getter(name="realmRolePrefix")
    def realm_role_prefix(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A prefix for each Realm Role.
        """
        return pulumi.get(self, "realm_role_prefix")
