...
class ClientArgs:
    def __init__(__self__, *,
                 ...
                 allow_refresh_token_in_standard_token_exchange: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 backchannel_logout_session_required: Optional[pulumi.Input[builtins.bool]] = None,
                 backchannel_logout_url: Optional[pulumi.Input[builtins.str]] = None,
                 base_url: Optional[pulumi.Input[builtins.str]] = None,
                 client_authenticator_type: Optional[pulumi.Input[builtins.str]] = None,
                 client_id: Optional[pulumi.Input[builtins.str]] = None,
                 client_offline_session_idle_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 client_offline_session_max_lifespan: Optional[pulumi.Input[builtins.str]] = None,
                 client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 client_secret_regenerate_when_changed: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 client_secret_wo_version: Optional[pulumi.Input[builtins.int]] = None,
                 client_session_idle_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 client_session_max_lifespan: Optional[pulumi.Input[builtins.str]] = None,
                 consent_required: Optional[pulumi.Input[builtins.bool]] = None,
                 consent_screen_text: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 frontchannel_logout_url: Optional[pulumi.Input[builtins.str]] = None,
                 full_scope_allowed: Optional[pulumi.Input[builtins.bool]] = None,
                 implicit_flow_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 import_: Optional[pulumi.Input[builtins.bool]] = None,
                 login_theme: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 oauth2_device_authorization_grant_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 oauth2_device_code_lifespan: Optional[pulumi.Input[builtins.str]] = None,
                 oauth2_device_polling_interval: Optional[pulumi.Input[builtins.str]] = None,
                 pkce_code_challenge_method: Optional[pulumi.Input[builtins.str]] = None,
                 root_url: Optional[pulumi.Input[builtins.str]] = None,
                 service_accounts_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 standard_flow_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 standard_token_exchange_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 use_refresh_tokens: Optional[pulumi.Input[builtins.bool]] = None,
                 use_refresh_tokens_client_credentials: Optional[pulumi.Input[builtins.bool]] = None,
                 valid_post_logout_redirect_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 valid_redirect_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 web_origins: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Client resource.
        :param pulumi.Input[builtins.str] access_type: Specifies the type of client, which can be one of the following:
        ...
        :param pulumi.Input[builtins.bool] backchannel_logout_session_required: When `true`, a sid (session ID) claim will be included in the logout token when the backchannel logout URL is used. Defaults to `true`.
        :param pulumi.Input[builtins.str] backchannel_logout_url: The URL that will cause the client to log itself out when a logout request is sent to this realm. If omitted, no logout request will be sent to the client is this case.
        :param pulumi.Input[builtins.str] base_url: Default URL to use when the auth server needs to redirect or link back to the client.
        :param pulumi.Input[builtins.str] client_authenticator_type: Defaults to `client-secret`. The authenticator type for clients with an `access_type` of `CONFIDENTIAL` or `BEARER-ONLY`. A default Keycloak installation will have the following available types:
        ...
        :param pulumi.Input[builtins.str] client_id: The Client ID for this client, referenced in the URI during authentication and in issued tokens.
        :param pulumi.Input[builtins.str] client_offline_session_idle_timeout: Time a client session is allowed to be idle before it expires. Tokens are invalidated when a client session is expired. If not set it uses the standard SSO Session Idle value.
        :param pulumi.Input[builtins.str] client_offline_session_max_lifespan: Max time before a client session is expired. Tokens are invalidated when a client session is expired. If not set, it uses the standard SSO Session Max value.
        :param pulumi.Input[builtins.str] client_secret: The secret for clients with an `access_type` of `CONFIDENTIAL` or `BEARER-ONLY`. This value is sensitive and should be treated with the same care as a password. If omitted, this will be generated by Keycloak.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] client_secret_regenerate_when_changed: Arbitrary map of values that, when changed, will trigger rotation of the secret. NOTE! Conflicts with `client_secret`, `client_secret_wo` and `client_secret_wo_version` attribute and can't be used together
        :param pulumi.Input[builtins.int] client_secret_wo_version: Version of the Client secret write-only argument
        :param pulumi.Input[builtins.str] client_session_idle_timeout: Time a client offline session is allowed to be idle before it expires. Offline tokens are invalidated when a client offline session is expired. If not set it uses the Offline Session Idle value.
        :param pulumi.Input[builtins.str] client_session_max_lifespan: Max time before a client offline session is expired. Offline tokens are invalidated when a client offline session is expired. If not set, it uses the Offline Session Max value.
        :param pulumi.Input[builtins.bool] consent_required: When `true`, users have to consent to client access. Defaults to `false`.
        :param pulumi.Input[builtins.str] consent_screen_text: The text to display on the consent screen about permissions specific to this client. This is applicable only when `display_on_consent_screen` is `true`.
        ...
        :param pulumi.Input[builtins.bool] implicit_flow_enabled: When `true`, the OAuth2 Implicit Grant will be enabled for this client. Defaults to `false`.
        :param pulumi.Input[builtins.bool] import_: When `true`, the client with the specified `client_id` is assumed to already exist, and it will be imported into state instead of being created. This attribute is useful when dealing with clients that Keycloak creates automatically during realm creation, such as `account` and `admin-cli`. Note, that the client will not be removed during destruction if `import` is `true`.
        :param pulumi.Input[builtins.str] login_theme: The client login theme. This will override the default theme for the realm.
        :param pulumi.Input[builtins.str] name: The display name of this client in the GUI.
        :param pulumi.Input[builtins.bool] oauth2_device_authorization_grant_enabled: Enables support for OAuth 2.0 Device Authorization Grant, which means that client is an application on device that has limited input capabilities or lack a suitable browser.
        :param pulumi.Input[builtins.str] oauth2_device_code_lifespan: The maximum amount of time a client has to finish the device code flow before it expires.
        :param pulumi.Input[builtins.str] oauth2_device_polling_interval: The minimum amount of time in seconds that the client should wait between polling requests to the token endpoint.
        :param pulumi.Input[builtins.str] pkce_code_challenge_method: The challenge method to use for Proof Key for Code Exchange. Can be either `plain` or `S256` or set to empty value ``.
        :param pulumi.Input[builtins.str] root_url: When specified, this URL is prepended to any relative URLs found within `valid_redirect_uris`, `web_origins`, and `admin_url`. NOTE: Due to limitations in the Keycloak API, when the `root_url` attribute is used, the `valid_redirect_uris`, `web_origins`, and `admin_url` attributes will be required.
        :param pulumi.Input[builtins.bool] service_accounts_enabled: When `true`, the OAuth2 Client Credentials grant will be enabled for this client. Defaults to `false`.
        :param pulumi.Input[builtins.bool] standard_flow_enabled: When `true`, the OAuth2 Authorization Code Grant will be enabled for this client. Defaults to `false`.
        :param pulumi.Input[builtins.bool] use_refresh_tokens: If this is `true`, a refresh_token will be created and added to the token response. If this is `false` then no refresh_token will be generated.  Defaults to `true`.
        :param pulumi.Input[builtins.bool] use_refresh_tokens_client_credentials: If this is `true`, a refresh_token will be created and added to the token response if the client_credentials grant is used and a user session will be created. If this is `false` then no refresh_token will be generated and the associated user session will be removed, in accordance with OAuth 2.0 RFC6749 Section 4.4.3. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] valid_post_logout_redirect_uris: A list of valid URIs a browser is permitted to redirect to after a successful logout.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] valid_redirect_uris: A list of valid URIs a browser is permitted to redirect to after a successful login or logout. Simple
               wildcards in the form of an asterisk can be used here. This attribute must be set if either `standard_flow_enabled` or `implicit_flow_enabled`
               is set to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] web_origins: A list of allowed CORS origins. To permit all valid redirect URIs, add `+`. Note that this will not include the `*` wildcard. To permit all origins, explicitly add `*`.
        """
        ...
        if allow_refresh_token_in_standard_token_exchange is not None:
        ...
        if client_secret_regenerate_when_changed is not None:
            pulumi.set(__self__, "client_secret_regenerate_when_changed", client_secret_regenerate_when_changed)
        ...
        if standard_token_exchange_enabled is not None:
    ...
    def access_token_lifespan(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_token_lifespan(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def allow_refresh_token_in_standard_token_exchange(self) -> Optional[pulumi.Input[builtins.str]]:
    ...
    def allow_refresh_token_in_standard_token_exchange(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def backchannel_logout_revoke_offline_sessions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def backchannel_logout_revoke_offline_sessions(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "backchannel_logout_revoke_offline_sessions", value)

    @property
    @pulumi.getter(name="backchannelLogoutSessionRequired")
    def backchannel_logout_session_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def backchannel_logout_session_required(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "backchannel_logout_session_required", value)

    @property
    @pulumi.getter(name="backchannelLogoutUrl")
    def backchannel_logout_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backchannel_logout_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def client_authenticator_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_authenticator_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def client_offline_session_idle_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_offline_session_idle_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_offline_session_idle_timeout", value)

    @property
    @pulumi.getter(name="clientOfflineSessionMaxLifespan")
    def client_offline_session_max_lifespan(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_offline_session_max_lifespan(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def client_secret_regenerate_when_changed(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def client_secret_regenerate_when_changed(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def client_session_idle_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_session_idle_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_session_idle_timeout", value)

    @property
    @pulumi.getter(name="clientSessionMaxLifespan")
    def client_session_max_lifespan(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_session_max_lifespan(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def consent_screen_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def consent_screen_text(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def direct_access_grants_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def direct_access_grants_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "direct_access_grants_enabled", value)

    @property
    @pulumi.getter(name="displayOnConsentScreen")
    def display_on_consent_screen(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def display_on_consent_screen(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def exclude_session_state_from_auth_response(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def exclude_session_state_from_auth_response(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def frontchannel_logout_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def frontchannel_logout_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "frontchannel_logout_enabled", value)

    @property
    @pulumi.getter(name="frontchannelLogoutUrl")
    def frontchannel_logout_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def frontchannel_logout_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def implicit_flow_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def implicit_flow_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def oauth2_device_authorization_grant_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def oauth2_device_authorization_grant_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "oauth2_device_authorization_grant_enabled", value)

    @property
    @pulumi.getter(name="oauth2DeviceCodeLifespan")
    def oauth2_device_code_lifespan(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth2_device_code_lifespan(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth2_device_code_lifespan", value)

    @property
    @pulumi.getter(name="oauth2DevicePollingInterval")
    def oauth2_device_polling_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth2_device_polling_interval(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oauth2_device_polling_interval", value)

    @property
    @pulumi.getter(name="pkceCodeChallengeMethod")
    def pkce_code_challenge_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pkce_code_challenge_method(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_accounts_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def service_accounts_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "service_accounts_enabled", value)

    @property
    @pulumi.getter(name="standardFlowEnabled")
    def standard_flow_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def standard_flow_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "standard_flow_enabled", value)

    @property
    @pulumi.getter(name="standardTokenExchangeEnabled")
    def standard_token_exchange_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "standard_token_exchange_enabled")

    @standard_token_exchange_enabled.setter
    def standard_token_exchange_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "standard_token_exchange_enabled", value)

    @property
    @pulumi.getter(name="useRefreshTokens")
    def use_refresh_tokens(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_refresh_tokens(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_refresh_tokens", value)

    @property
    @pulumi.getter(name="useRefreshTokensClientCredentials")
    def use_refresh_tokens_client_credentials(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_refresh_tokens_client_credentials(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_refresh_tokens_client_credentials", value)

    @property
    @pulumi.getter(name="validPostLogoutRedirectUris")
    def valid_post_logout_redirect_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def valid_post_logout_redirect_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def web_origins(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @web_origins.setter
    def web_origins(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ClientState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] pkce_code_challenge_method: The challenge method to use for Proof Key for Code Exchange. Can be either `plain` or `S256` or set to empty value ``.
        :param pulumi.Input[builtins.str] realm_id: The realm this client is attached to.
        :param pulumi.Input[builtins.str] resource_server_id: (Computed) When authorization is enabled for this client, this attribute is the unique ID for the client (the same value as the `.id` attribute).
        :param pulumi.Input[builtins.str] root_url: When specified, this URL is prepended to any relative URLs found within `valid_redirect_uris`, `web_origins`, and `admin_url`. NOTE: Due to limitations in the Keycloak API, when the `root_url` attribute is used, the `valid_redirect_uris`, `web_origins`, and `admin_url` attributes will be required.
        :param pulumi.Input[builtins.str] service_account_user_id: (Computed) When service accounts are enabled for this client, this attribute is the unique ID for the Keycloak user that represents this service account.
        :param pulumi.Input[builtins.bool] service_accounts_enabled: When `true`, the OAuth2 Client Credentials grant will be enabled for this client. Defaults to `false`.
        :param pulumi.Input[builtins.bool] standard_flow_enabled: When `true`, the OAuth2 Authorization Code Grant will be enabled for this client. Defaults to `false`.
        :param pulumi.Input[builtins.bool] use_refresh_tokens: If this is `true`, a refresh_token will be created and added to the token response. If this is `false` then no refresh_token will be generated.  Defaults to `true`.
        :param pulumi.Input[builtins.bool] use_refresh_tokens_client_credentials: If this is `true`, a refresh_token will be created and added to the token response if the client_credentials grant is used and a user session will be created. If this is `false` then no refresh_token will be generated and the associated user session will be removed, in accordance with OAuth 2.0 RFC6749 Section 4.4.3. Defaults to `false`.
...
class Client(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["allow_refresh_token_in_standard_token_exchange"] = allow_refresh_token_in_standard_token_exchange
            ...
            __props__.__dict__["client_secret_regenerate_when_changed"] = client_secret_regenerate_when_changed
            ...
            __props__.__dict__["standard_token_exchange_enabled"] = standard_token_exchange_enabled
    ...
    def get(resource_name: str,
            ...
            valid_post_logout_redirect_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            valid_redirect_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            web_origins: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Client':
        """
    ...
    @property
    @pulumi.getter(name="accessTokenLifespan")
    def access_token_lifespan(self) -> pulumi.Output[builtins.str]:
        """
        The amount of time in seconds before an access token expires. This will override the default for the realm.
        """
        return pulumi.get(self, "access_token_lifespan")
    ...
    @property
    @pulumi.getter(name="allowRefreshTokenInStandardTokenExchange")
    def allow_refresh_token_in_standard_token_exchange(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "allow_refresh_token_in_standard_token_exchange")
    ...
    @property
    @pulumi.getter(name="backchannelLogoutRevokeOfflineSessions")
    def backchannel_logout_revoke_offline_sessions(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifying whether a "revoke_offline_access" event is included in the Logout Token when the Backchannel Logout URL is used. Keycloak will revoke offline sessions when receiving a Logout Token with this event.
        """
        return pulumi.get(self, "backchannel_logout_revoke_offline_sessions")
    ...
    @property
    @pulumi.getter(name="backchannelLogoutSessionRequired")
    def backchannel_logout_session_required(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, a sid (session ID) claim will be included in the logout token when the backchannel logout URL is used. Defaults to `true`.
        """
        return pulumi.get(self, "backchannel_logout_session_required")
    ...
    @property
    @pulumi.getter(name="backchannelLogoutUrl")
    def backchannel_logout_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL that will cause the client to log itself out when a logout request is sent to this realm. If omitted, no logout request will be sent to the client is this case.
        """
        return pulumi.get(self, "backchannel_logout_url")
    ...
    @property
    @pulumi.getter(name="clientAuthenticatorType")
    def client_authenticator_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defaults to `client-secret`. The authenticator type for clients with an `access_type` of `CONFIDENTIAL` or `BEARER-ONLY`. A default Keycloak installation will have the following available types:
        - `client-secret` (Default) Use client id and client secret to authenticate client.
        - `client-jwt` Use signed JWT to authenticate client. Set signing algorithm in `extra_config` with `attributes.token.endpoint.auth.signing.alg = <alg>`
    ...
    @property
    @pulumi.getter(name="clientOfflineSessionIdleTimeout")
    def client_offline_session_idle_timeout(self) -> pulumi.Output[builtins.str]:
        """
        Time a client session is allowed to be idle before it expires. Tokens are invalidated when a client session is expired. If not set it uses the standard SSO Session Idle value.
        """
        return pulumi.get(self, "client_offline_session_idle_timeout")
    ...
    @property
    @pulumi.getter(name="clientOfflineSessionMaxLifespan")
    def client_offline_session_max_lifespan(self) -> pulumi.Output[builtins.str]:
        """
        Max time before a client session is expired. Tokens are invalidated when a client session is expired. If not set, it uses the standard SSO Session Max value.
        """
        return pulumi.get(self, "client_offline_session_max_lifespan")
    ...
    @property
    @pulumi.getter(name="clientSecretRegenerateWhenChanged")
    def client_secret_regenerate_when_changed(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Arbitrary map of values that, when changed, will trigger rotation of the secret. NOTE! Conflicts with `client_secret`, `client_secret_wo` and `client_secret_wo_version` attribute and can't be used together
        """
        return pulumi.get(self, "client_secret_regenerate_when_changed")
    ...
    @property
    @pulumi.getter(name="clientSessionIdleTimeout")
    def client_session_idle_timeout(self) -> pulumi.Output[builtins.str]:
        """
        Time a client offline session is allowed to be idle before it expires. Offline tokens are invalidated when a client offline session is expired. If not set it uses the Offline Session Idle value.
        """
        return pulumi.get(self, "client_session_idle_timeout")
    ...
    @property
    @pulumi.getter(name="clientSessionMaxLifespan")
    def client_session_max_lifespan(self) -> pulumi.Output[builtins.str]:
        """
        Max time before a client offline session is expired. Offline tokens are invalidated when a client offline session is expired. If not set, it uses the Offline Session Max value.
        """
        return pulumi.get(self, "client_session_max_lifespan")
    ...
    @property
    @pulumi.getter(name="consentScreenText")
    def consent_screen_text(self) -> pulumi.Output[builtins.str]:
        """
        The text to display on the consent screen about permissions specific to this client. This is applicable only when `display_on_consent_screen` is `true`.
        """
        return pulumi.get(self, "consent_screen_text")
    ...
    @property
    @pulumi.getter(name="directAccessGrantsEnabled")
    def direct_access_grants_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        When `true`, the OAuth2 Resource Owner Password Grant will be enabled for this client. Defaults to `false`.
        """
        return pulumi.get(self, "direct_access_grants_enabled")
    ...
    @property
    @pulumi.getter(name="displayOnConsentScreen")
    def display_on_consent_screen(self) -> pulumi.Output[builtins.bool]:
        """
        When `true`, the consent screen will display information about the client itself. Defaults to `false`. This is applicable only when `consent_required` is `true`.
        """
        return pulumi.get(self, "display_on_consent_screen")
    ...
    @property
    @pulumi.getter(name="excludeSessionStateFromAuthResponse")
    def exclude_session_state_from_auth_response(self) -> pulumi.Output[builtins.bool]:
        """
        When `true`, the parameter `session_state` will not be included in OpenID Connect Authentication Response.
        """
        return pulumi.get(self, "exclude_session_state_from_auth_response")
    ...
    @property
    @pulumi.getter(name="frontchannelLogoutEnabled")
    def frontchannel_logout_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        When `true`, frontchannel logout will be enabled for this client. Specify the url with `frontchannel_logout_url`. Defaults to `false`.
        """
        return pulumi.get(self, "frontchannel_logout_enabled")
    ...
    @property
    @pulumi.getter(name="frontchannelLogoutUrl")
    def frontchannel_logout_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The frontchannel logout url. This is applicable only when `frontchannel_logout_enabled` is `true`.
        """
        return pulumi.get(self, "frontchannel_logout_url")
    ...
    @property
    @pulumi.getter(name="implicitFlowEnabled")
    def implicit_flow_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        When `true`, the OAuth2 Implicit Grant will be enabled for this client. Defaults to `false`.
        """
        return pulumi.get(self, "implicit_flow_enabled")
    ...
    @property
    @pulumi.getter(name="oauth2DeviceAuthorizationGrantEnabled")
    def oauth2_device_authorization_grant_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables support for OAuth 2.0 Device Authorization Grant, which means that client is an application on device that has limited input capabilities or lack a suitable browser.
        """
        return pulumi.get(self, "oauth2_device_authorization_grant_enabled")
    ...
    @property
    @pulumi.getter(name="oauth2DeviceCodeLifespan")
    def oauth2_device_code_lifespan(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The maximum amount of time a client has to finish the device code flow before it expires.
        """
        return pulumi.get(self, "oauth2_device_code_lifespan")
    ...
    @property
    @pulumi.getter(name="oauth2DevicePollingInterval")
    def oauth2_device_polling_interval(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The minimum amount of time in seconds that the client should wait between polling requests to the token endpoint.
        """
        return pulumi.get(self, "oauth2_device_polling_interval")
    ...
    @property
    @pulumi.getter(name="pkceCodeChallengeMethod")
    def pkce_code_challenge_method(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The challenge method to use for Proof Key for Code Exchange. Can be either `plain` or `S256` or set to empty value ``.
        """
        return pulumi.get(self, "pkce_code_challenge_method")
    ...
    @property
    @pulumi.getter(name="rootUrl")
    def root_url(self) -> pulumi.Output[builtins.str]:
        """
        When specified, this URL is prepended to any relative URLs found within `valid_redirect_uris`, `web_origins`, and `admin_url`. NOTE: Due to limitations in the Keycloak API, when the `root_url` attribute is used, the `valid_redirect_uris`, `web_origins`, and `admin_url` attributes will be required.
        """
        return pulumi.get(self, "root_url")
    ...
    @property
    @pulumi.getter(name="serviceAccountsEnabled")
    def service_accounts_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        When `true`, the OAuth2 Client Credentials grant will be enabled for this client. Defaults to `false`.
        """
        return pulumi.get(self, "service_accounts_enabled")
    ...
    @property
    @pulumi.getter(name="standardFlowEnabled")
    def standard_flow_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        When `true`, the OAuth2 Authorization Code Grant will be enabled for this client. Defaults to `false`.
        """
        return pulumi.get(self, "standard_flow_enabled")
    ...
    @property
    @pulumi.getter(name="standardTokenExchangeEnabled")
    def standard_token_exchange_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "standard_token_exchange_enabled")

    @property
    @pulumi.getter(name="useRefreshTokens")
    def use_refresh_tokens(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If this is `true`, a refresh_token will be created and added to the token response. If this is `false` then no refresh_token will be generated.  Defaults to `true`.
        """
        return pulumi.get(self, "use_refresh_tokens")
    ...
    @property
    @pulumi.getter(name="useRefreshTokensClientCredentials")
    def use_refresh_tokens_client_credentials(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If this is `true`, a refresh_token will be created and added to the token response if the client_credentials grant is used and a user session will be created. If this is `false` then no refresh_token will be generated and the associated user session will be removed, in accordance with OAuth 2.0 RFC6749 Section 4.4.3. Defaults to `false`.
        """
        return pulumi.get(self, "use_refresh_tokens_client_credentials")
    ...
    @property
    @pulumi.getter(name="validPostLogoutRedirectUris")
    def valid_post_logout_redirect_uris(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of valid URIs a browser is permitted to redirect to after a successful logout.
        """
        return pulumi.get(self, "valid_post_logout_redirect_uris")
    ...
    @property
    @pulumi.getter(name="validRedirectUris")
    def valid_redirect_uris(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of valid URIs a browser is permitted to redirect to after a successful login or logout. Simple
        wildcards in the form of an asterisk can be used here. This attribute must be set if either `standard_flow_enabled` or `implicit_flow_enabled`
        is set to `true`.
    ...
    @property
    @pulumi.getter(name="webOrigins")
    def web_origins(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of allowed CORS origins. To permit all valid redirect URIs, add `+`. Note that this will not include the `*` wildcard. To permit all origins, explicitly add `*`.
        """
        return pulumi.get(self, "web_origins")
