...
class ClientPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] clients: The clients allowed by this client policy.
        :param pulumi.Input[builtins.str] realm_id: The realm this client policy exists within.
        :param pulumi.Input[builtins.str] resource_server_id: The ID of the resource server this client policy is attached to.
        :param pulumi.Input[builtins.str] decision_strategy: (Computed) Dictates how the policies associated with a given permission are evaluated and how a final decision is obtained. Could be one of `AFFIRMATIVE`, `CONSENSUS`, or `UNANIMOUS`. Applies to permissions.
        :param pulumi.Input[builtins.str] description: The description of this client policy.
        :param pulumi.Input[builtins.str] logic: (Computed) Dictates how the policy decision should be made. Can be either `POSITIVE` or `NEGATIVE`. Applies to policies.
        :param pulumi.Input[builtins.str] name: The name of this client policy.
        """
...
class ClientPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_server_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientPolicy':
        """
