...
class ClientDefaultScopesArgs:
    def __init__(__self__, *,
                 ...
                 default_scopes: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 realm_id: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a ClientDefaultScopes resource.
        :param pulumi.Input[_builtins.str] client_id: The ID of the client to attach default scopes to. Note that this is the unique ID of the client generated by Keycloak.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] default_scopes: An array of client scope names to attach to this client.
    ...
    def default_scopes(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def default_scopes(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ClientDefaultScopes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            client_id: Optional[pulumi.Input[_builtins.str]] = None,
            default_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            realm_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ClientDefaultScopes':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultScopes")
    def default_scopes(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        An array of client scope names to attach to this client.
        """
        return pulumi.get(self, "default_scopes")
