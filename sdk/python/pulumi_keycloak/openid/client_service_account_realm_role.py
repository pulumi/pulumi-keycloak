...
class ClientServiceAccountRealmRole(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, realm_id=None, role=None, service_account_user_id=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, realm_id=None, role=None, service_account_user_id=None):
        """
