...
class HardcodedRoleProtocolMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_id: The ID of the role to map to an access token.
...
class HardcodedRoleProtocolMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None,
            role_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HardcodedRoleProtocolMapper':
        """
