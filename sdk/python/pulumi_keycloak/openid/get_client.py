...
class GetClientResult:
    ...
    def backchannel_logout_revoke_offline_sessions(self) -> builtins.bool:
        return pulumi.get(self, "backchannel_logout_revoke_offline_sessions")

    @property
    @pulumi.getter(name="backchannelLogoutSessionRequired")
    def backchannel_logout_session_required(self) -> builtins.bool:
    ...
    def consent_screen_text(self) -> Optional[builtins.str]:
    ...
    def display_on_consent_screen(self) -> Optional[builtins.bool]:
    ...
    def exclude_session_state_from_auth_response(self) -> builtins.bool:
        return pulumi.get(self, "exclude_session_state_from_auth_response")

    @property
    @pulumi.getter(name="extraConfig")
    def extra_config(self) -> Mapping[str, builtins.str]:
        return pulumi.get(self, "extra_config")

    @property
    @pulumi.getter(name="frontchannelLogoutEnabled")
    def frontchannel_logout_enabled(self) -> builtins.bool:
...
def get_client(always_display_in_console: Optional[builtins.bool] = None,
               ...
               oauth2_device_authorization_grant_enabled: Optional[builtins.bool] = None,
               oauth2_device_code_lifespan: Optional[builtins.str] = None,
               oauth2_device_polling_interval: Optional[builtins.str] = None,
    ...
    :param builtins.str client_id: The client id (not its unique ID).
...
def get_client_output(always_display_in_console: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      ...
                      oauth2_device_authorization_grant_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                      oauth2_device_code_lifespan: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      oauth2_device_polling_interval: Optional[pulumi.Input[Optional[builtins.str]]] = None,
