...
class UserClientRoleProtocolMapperArgs:
    def __init__(__self__, *,
                 ...
                 client_id_for_role_mappings: pulumi.Input[Optional[_builtins.str]] = None,
                 client_role_prefix: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] client_id_for_role_mappings: The Client ID for role mappings. Just client roles of this client will be added to the token. If this is unset, client roles of all clients will be added to the token.
        :param pulumi.Input[_builtins.str] client_role_prefix: A prefix for each Client Role.
        ...
        :param pulumi.Input[_builtins.bool] multivalued: Indicates if attribute supports multiple values. If true, then the list of all values of this attribute will be set as claim. If false, then just first value will be set as claim. Defaults to `false`.
    ...
    def client_id_for_role_mappings(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def client_id_for_role_mappings(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "client_id_for_role_mappings", value)

    @_builtins.property
    @pulumi.getter(name="clientRolePrefix")
    def client_role_prefix(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def client_role_prefix(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class UserClientRoleProtocolMapper(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        $ pulumi import keycloak:openid/userClientRoleProtocolMapper:UserClientRoleProtocolMapper user_client_role_mapper my-realm/client/a7202154-8793-4656-b655-1dd18c181e14/name/my%20protocol%20mapper
        $ pulumi import keycloak:openid/userClientRoleProtocolMapper:UserClientRoleProtocolMapper user_client_role_mapper my-realm/client-scope/b799ea7e-73ee-4a73-990a-1eafebe8e20a/name/my%20protocol%20mapper
        ```
    ...
    def get(resource_name: str,
            ...
            multivalued: pulumi.Input[Optional[_builtins.bool]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            realm_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'UserClientRoleProtocolMapper':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="claimName")
    def claim_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the claim to insert into a token.
        """
        return pulumi.get(self, "claim_name")
    ...
    @_builtins.property
    @pulumi.getter(name="claimValueType")
    def claim_value_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The claim type used when serializing JSON tokens. Can be one of `String`, `JSON`, `long`, `int`, or `boolean`. Defaults to `String`.
        """
        return pulumi.get(self, "claim_value_type")
    ...
    @_builtins.property
    @pulumi.getter(name="clientIdForRoleMappings")
    def client_id_for_role_mappings(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The Client ID for role mappings. Just client roles of this client will be added to the token. If this is unset, client roles of all clients will be added to the token.
        """
        return pulumi.get(self, "client_id_for_role_mappings")
    ...
    @_builtins.property
    @pulumi.getter(name="clientRolePrefix")
    def client_role_prefix(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A prefix for each Client Role.
        """
        return pulumi.get(self, "client_role_prefix")
    ...
    @_builtins.property
    @pulumi.getter
    def multivalued(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Indicates if attribute supports multiple values. If true, then the list of all values of this attribute will be set as claim. If false, then just first value will be set as claim. Defaults to `false`.
        """
        return pulumi.get(self, "multivalued")
