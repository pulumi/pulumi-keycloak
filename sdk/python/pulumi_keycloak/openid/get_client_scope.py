...
class GetClientScopeResult:
    ...
    def gui_order(self) -> builtins.int:
    ...
    def include_in_token_scope(self) -> builtins.bool:
...
def get_client_scope(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the client scope.
...
def get_client_scope_output(name: Optional[pulumi.Input[builtins.str]] = None,
