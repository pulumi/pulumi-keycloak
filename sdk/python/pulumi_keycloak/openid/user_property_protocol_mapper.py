...
class UserPropertyProtocolMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_property: The built-in user property (such as email) to map a claim for.
        ...
        :param pulumi.Input[_builtins.str] client_scope_id: The client scope this protocol mapper should be attached to. Conflicts with `client_id`. One of `client_id` or `client_scope_id` must be specified. `client_scope_id` - (Required if `client_id` is not specified) The client scope this protocol mapper is attached to.
...
@pulumi.type_token("keycloak:openid/userPropertyProtocolMapper:UserPropertyProtocolMapper")
class UserPropertyProtocolMapper(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        $ pulumi import keycloak:openid/userPropertyProtocolMapper:UserPropertyProtocolMapper user_property_mapper my-realm/client/a7202154-8793-4656-b655-1dd18c181e14/name/my%20protocol%20mapper
        $ pulumi import keycloak:openid/userPropertyProtocolMapper:UserPropertyProtocolMapper user_property_mapper my-realm/client-scope/b799ea7e-73ee-4a73-990a-1eafebe8e20a/name/my%20protocol%20mapper
        ```
