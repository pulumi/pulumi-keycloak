...
class UserPropertyProtocolMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] user_property: The built-in user property (such as email) to map a claim for.
        ...
        :param pulumi.Input[builtins.str] client_scope_id: The client scope this protocol mapper should be attached to. Conflicts with `client_id`. One of `client_id` or `client_scope_id` must be specified. `client_scope_id` - (Required if `client_id` is not specified) The client scope this protocol mapper is attached to.
