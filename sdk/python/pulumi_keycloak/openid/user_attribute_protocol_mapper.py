...
class UserAttributeProtocolMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] user_attribute: The custom user attribute to map a claim for.
        :param pulumi.Input[builtins.bool] add_to_access_token: Indicates if the attribute should be added as a claim to the access token. Defaults to `true`.
        :param pulumi.Input[builtins.bool] add_to_id_token: Indicates if the attribute should be added as a claim to the id token. Defaults to `true`.
        :param pulumi.Input[builtins.bool] add_to_userinfo: Indicates if the attribute should be added as a claim to the UserInfo response body. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.bool] multivalued: Indicates whether this attribute is a single value or an array of values. Defaults to `false`.
