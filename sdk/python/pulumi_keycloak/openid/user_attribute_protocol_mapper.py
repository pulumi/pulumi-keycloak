...
class UserAttributeProtocolMapperArgs:
    ...
    def _configure(
        ...
        if aggregate_attributes is None and 'aggregateAttributes' in kwargs:
            aggregate_attributes = kwargs['aggregateAttributes']
        ...
        if aggregate_attributes is not None:
            _setter("aggregate_attributes", aggregate_attributes)
