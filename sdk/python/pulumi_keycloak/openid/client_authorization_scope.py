...
class ClientAuthorizationScope(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, display_name=None, icon_uri=None, name=None, realm_id=None, resource_server_id=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, display_name=None, icon_uri=None, name=None, realm_id=None, resource_server_id=None):
        """
