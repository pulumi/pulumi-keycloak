...
def get_client_authorization_policy(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the authorization policy.
    :param _builtins.str realm_id: The realm this authorization policy exists within.
    :param _builtins.str resource_server_id: The ID of the resource server this authorization policy is attached to.
    """
    __args__ = dict()
    __args__['name'] = name
