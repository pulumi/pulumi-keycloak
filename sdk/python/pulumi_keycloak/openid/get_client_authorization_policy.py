...
def get_client_authorization_policy(name: Optional[builtins.str] = None,
                                    realm_id: Optional[builtins.str] = None,
                                    resource_server_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the authorization policy.
    :param builtins.str realm_id: The realm this authorization policy exists within.
    :param builtins.str resource_server_id: The ID of the resource server this authorization policy is attached to.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_client_authorization_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
