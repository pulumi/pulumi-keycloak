...
class RealmEventsArgs:
    def __init__(__self__, *,
                 ...
                 admin_events_details_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 admin_events_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled_event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 events_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 events_expiration: Optional[pulumi.Input[builtins.int]] = None,
                 events_listeners: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a RealmEvents resource.
        :param pulumi.Input[builtins.str] realm_id: The name of the realm the event settings apply to.
        :param pulumi.Input[builtins.bool] admin_events_details_enabled: When `true`, saved admin events will included detailed information for create/update requests. Defaults to `false`.
        :param pulumi.Input[builtins.bool] admin_events_enabled: When `true`, admin events are saved to the database, making them available through the admin console. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_event_types: The event types that will be saved to the database. Omitting this field enables all event types. Defaults to `[]` or all event types.
        :param pulumi.Input[builtins.bool] events_enabled: When `true`, events from `enabled_event_types` are saved to the database, making them available through the admin console. Defaults to `false`.
        :param pulumi.Input[builtins.int] events_expiration: The amount of time in seconds events will be saved in the database. Defaults to `0` or never.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events_listeners: The event listeners that events should be sent to. Defaults to `[]` or none. Note that new realms enable the `jboss-logging` listener by default, and this resource will remove that unless it is specified.
        """
    ...
    def admin_events_details_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def admin_events_details_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "admin_events_details_enabled", value)

    @property
    @pulumi.getter(name="adminEventsEnabled")
    def admin_events_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def admin_events_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "admin_events_enabled", value)

    @property
    @pulumi.getter(name="enabledEventTypes")
    def enabled_event_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def enabled_event_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "enabled_event_types", value)

    @property
    @pulumi.getter(name="eventsEnabled")
    def events_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def events_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "events_enabled", value)

    @property
    @pulumi.getter(name="eventsExpiration")
    def events_expiration(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def events_expiration(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "events_expiration", value)

    @property
    @pulumi.getter(name="eventsListeners")
    def events_listeners(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def events_listeners(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("keycloak:index/realmEvents:RealmEvents")
class RealmEvents(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            events_expiration: Optional[pulumi.Input[builtins.int]] = None,
            events_listeners: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RealmEvents':
        """
    ...
    @property
    @pulumi.getter(name="adminEventsDetailsEnabled")
    def admin_events_details_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, saved admin events will included detailed information for create/update requests. Defaults to `false`.
        """
        return pulumi.get(self, "admin_events_details_enabled")
    ...
    @property
    @pulumi.getter(name="adminEventsEnabled")
    def admin_events_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, admin events are saved to the database, making them available through the admin console. Defaults to `false`.
        """
        return pulumi.get(self, "admin_events_enabled")
    ...
    @property
    @pulumi.getter(name="enabledEventTypes")
    def enabled_event_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The event types that will be saved to the database. Omitting this field enables all event types. Defaults to `[]` or all event types.
        """
        return pulumi.get(self, "enabled_event_types")
    ...
    @property
    @pulumi.getter(name="eventsEnabled")
    def events_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, events from `enabled_event_types` are saved to the database, making them available through the admin console. Defaults to `false`.
        """
        return pulumi.get(self, "events_enabled")
    ...
    @property
    @pulumi.getter(name="eventsExpiration")
    def events_expiration(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The amount of time in seconds events will be saved in the database. Defaults to `0` or never.
        """
        return pulumi.get(self, "events_expiration")
    ...
    @property
    @pulumi.getter(name="eventsListeners")
    def events_listeners(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The event listeners that events should be sent to. Defaults to `[]` or none. Note that new realms enable the `jboss-logging` listener by default, and this resource will remove that unless it is specified.
        """
        return pulumi.get(self, "events_listeners")
