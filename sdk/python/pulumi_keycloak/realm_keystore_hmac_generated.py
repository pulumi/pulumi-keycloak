...
class RealmKeystoreHmacGeneratedArgs:
    def __init__(__self__, *,
                 ...
                 secret_size: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] algorithm: Intended algorithm for the key. Defaults to `HS256`
        ...
        :param pulumi.Input[builtins.int] secret_size: Size in bytes for the generated secret. Defaults to `64`.
        """
    ...
    def secret_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @secret_size.setter
    def secret_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
@pulumi.type_token("keycloak:index/realmKeystoreHmacGenerated:RealmKeystoreHmacGenerated")
class RealmKeystoreHmacGenerated(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.int]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None,
            secret_size: Optional[pulumi.Input[builtins.int]] = None) -> 'RealmKeystoreHmacGenerated':
        """
    ...
    @property
    @pulumi.getter(name="secretSize")
    def secret_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Size in bytes for the generated secret. Defaults to `64`.
        """
        return pulumi.get(self, "secret_size")
