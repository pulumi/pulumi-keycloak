...
class IdentityProviderTokenExchangeScopePermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy_type: Defaults to "client" This is also the only value policy type supported by this provider.
        """
    ...
    def provider_alias(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def provider_alias(self, value: pulumi.Input[_builtins.str]):
...
class _IdentityProviderTokenExchangeScopePermissionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] clients: A list of IDs of the clients for which a policy will be created and set on scope based token exchange permission.
        :param pulumi.Input[_builtins.str] policy_id: (Computed) Policy ID that will be set on the scope based token exchange permission automatically created by enabling permissions on the reference identity provider.
        :param pulumi.Input[_builtins.str] policy_type: Defaults to "client" This is also the only value policy type supported by this provider.
        :param pulumi.Input[_builtins.str] provider_alias: Alias of the identity provider.
        :param pulumi.Input[_builtins.str] realm_id: The realm that the identity provider exists in.
        """
...
class IdentityProviderTokenExchangeScopePermission(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="authorizationIdpResourceId")
    def authorization_idp_resource_id(self) -> pulumi.Output[_builtins.str]:
        """
        (Computed) Resource ID representing the identity provider, this automatically created by keycloak.
        """
        return pulumi.get(self, "authorization_idp_resource_id")
    ...
    @_builtins.property
    @pulumi.getter(name="authorizationTokenExchangeScopePermissionId")
    def authorization_token_exchange_scope_permission_id(self) -> pulumi.Output[_builtins.str]:
        """
        (Computed) Permission ID representing the Permission with scope 'Token Exchange' and the resource 'authorization_idp_resource_id', this automatically created by keycloak, the policy ID will be set on this permission.
        """
        return pulumi.get(self, "authorization_token_exchange_scope_permission_id")
    ...
    @_builtins.property
    @pulumi.getter(name="providerAlias")
    def provider_alias(self) -> pulumi.Output[_builtins.str]:
        """
        Alias of the identity provider.
        """
        return pulumi.get(self, "provider_alias")
