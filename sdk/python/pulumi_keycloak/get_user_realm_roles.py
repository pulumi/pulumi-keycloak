...
def get_user_realm_roles(realm_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str realm_id: The realm this user belongs to.
    :param _builtins.str user_id: The ID of the user to query realm roles for.
    """
    __args__ = dict()
