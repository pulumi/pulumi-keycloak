...
def get_user_realm_roles(realm_id: Optional[builtins.str] = None,
    ...
    :param builtins.str user_id: The ID of the user to query realm roles for.
    """
    __args__ = dict()
...
def get_user_realm_roles_output(realm_id: Optional[pulumi.Input[builtins.str]] = None,
