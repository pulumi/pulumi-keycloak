...
class RealmKeystoreRsaGeneratedArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] key_size: Size for the generated keys. Defaults to `2048`.
...
class RealmKeystoreRsaGenerated(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            priority: Optional[pulumi.Input[_builtins.int]] = None,
            realm_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'RealmKeystoreRsaGenerated':
        """
