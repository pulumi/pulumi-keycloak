...
class HardcodedRoleIdentityMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] role: The name of the role which should be assigned to the users.
        """
...
class HardcodedRoleIdentityMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            realm: Optional[pulumi.Input[_builtins.str]] = None,
            role: Optional[pulumi.Input[_builtins.str]] = None) -> 'HardcodedRoleIdentityMapper':
        """
