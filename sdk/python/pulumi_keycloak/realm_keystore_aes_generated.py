...
class RealmKeystoreAesGeneratedArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] secret_size: Size in bytes for the generated AES Key. Size 16 is for AES-128, Size 24 for AES-192 and Size 32 for AES-256. WARN: Bigger keys then 128 bits are not allowed on some JDK implementations. Defaults to `16`.
        """
...
class RealmKeystoreAesGenerated(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.int]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None,
            secret_size: Optional[pulumi.Input[builtins.int]] = None) -> 'RealmKeystoreAesGenerated':
        """
