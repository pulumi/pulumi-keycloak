...
class CustomIdentityProviderMappingArgs:
    def __init__(__self__, *,
                 ...
                 identity_provider_mapper: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] identity_provider_mapper: The type of the identity provider mapper. This can be a format string that includes a `%s` - this will be replaced by the provider id.
    ...
    def identity_provider_mapper(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def identity_provider_mapper(self, value: pulumi.Input[builtins.str]):
...
class _CustomIdentityProviderMappingState:
    def __init__(__self__, *,
                 ...
                 identity_provider_mapper: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="identityProviderMapper")
    def identity_provider_mapper(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the identity provider mapper. This can be a format string that includes a `%s` - this will be replaced by the provider id.
        """
        return pulumi.get(self, "identity_provider_mapper")
    ...
    @identity_provider_mapper.setter
    def identity_provider_mapper(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "identity_provider_mapper", value)
...
class CustomIdentityProviderMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            identity_provider_mapper: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            realm: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomIdentityProviderMapping':
        """
    ...
    @property
    @pulumi.getter(name="identityProviderMapper")
    def identity_provider_mapper(self) -> pulumi.Output[builtins.str]:
        """
        The type of the identity provider mapper. This can be a format string that includes a `%s` - this will be replaced by the provider id.
        """
        return pulumi.get(self, "identity_provider_mapper")
