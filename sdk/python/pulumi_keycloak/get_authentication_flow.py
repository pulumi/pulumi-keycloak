...
def get_authentication_flow(alias: Optional[builtins.str] = None,
    ...
    :param builtins.str alias: The alias of the flow.
    :param builtins.str realm_id: The realm the authentication flow exists in.
    """
    __args__ = dict()
...
def get_authentication_flow_output(alias: Optional[pulumi.Input[builtins.str]] = None,
