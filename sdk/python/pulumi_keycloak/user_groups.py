...
class UserGroupsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_ids: A list of group IDs that the user is member of.
        :param pulumi.Input[builtins.str] realm_id: The realm this group exists in.
        :param pulumi.Input[builtins.str] user_id: The ID of the user this resource should manage groups for.
        :param pulumi.Input[builtins.bool] exhaustive: Indicates if the list of the user's groups is exhaustive. In this case, groups that are manually added to the user will be removed. Defaults to `true`.
        """
...
class UserGroups(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserGroups':
        """
