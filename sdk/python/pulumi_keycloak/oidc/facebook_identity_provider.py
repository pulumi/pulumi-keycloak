...
__all__ = ['FacebookIdentityProviderArgs', 'FacebookIdentityProvider']

@pulumi.input_type
class FacebookIdentityProviderArgs:
    def __init__(__self__, *,
                 ...
                 fetched_fields: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] provider_id: The ID of the identity provider to use. Defaults to `facebook`, which should be used unless you have extended Keycloak and provided your own implementation.
        ...
        if fetched_fields is not None:
            pulumi.set(__self__, "fetched_fields", fetched_fields)
    ...
    @_builtins.property
    @pulumi.getter(name="fetchedFields")
    def fetched_fields(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ...
        """
        return pulumi.get(self, "fetched_fields")

    @fetched_fields.setter
    def fetched_fields(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "fetched_fields", value)
...
@pulumi.input_type
class _FacebookIdentityProviderState:
    def __init__(__self__, *,
                 accepts_prompt_none_forward_from_client: pulumi.Input[Optional[_builtins.bool]] = None,
                 add_read_token_role_on_create: pulumi.Input[Optional[_builtins.bool]] = None,
                 alias: pulumi.Input[Optional[_builtins.str]] = None,
...
@pulumi.type_token("keycloak:oidc/facebookIdentityProvider:FacebookIdentityProvider")
class FacebookIdentityProvider(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FacebookIdentityProviderArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FacebookIdentityProviderArgs.__new__(FacebookIdentityProviderArgs)
            ...
            __props__.__dict__["fetched_fields"] = fetched_fields
        ...
        super(FacebookIdentityProvider, __self__).__init__(
            'keycloak:oidc/facebookIdentityProvider:FacebookIdentityProvider',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            store_token: pulumi.Input[Optional[_builtins.bool]] = None,
            sync_mode: pulumi.Input[Optional[_builtins.str]] = None,
            trust_email: pulumi.Input[Optional[_builtins.bool]] = None) -> 'FacebookIdentityProvider':
        """
        ...
        __props__ = _FacebookIdentityProviderState.__new__(_FacebookIdentityProviderState)
        ...
        __props__.__dict__["sync_mode"] = sync_mode
        __props__.__dict__["trust_email"] = trust_email
        return FacebookIdentityProvider(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="fetchedFields")
    def fetched_fields(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Provide additional fields which would be fetched using the profile request. This will be appended to the default set of `id,name,email,first_name,last_name`.
        """
        return pulumi.get(self, "fetched_fields")
