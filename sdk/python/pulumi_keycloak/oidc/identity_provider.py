...
class IdentityProviderArgs:
    def __init__(__self__, *,
                 ...
                 ui_locales: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] hide_on_login_page: When `true`, this provider will be hidden on the login page, and is only accessible when requested explicitly. Defaults to `false`.
        :param pulumi.Input[builtins.str] issuer: The issuer identifier for the issuer of the response. If not provided, no validation will be performed.
        :param pulumi.Input[builtins.str] jwks_url: JSON Web Key Set URL.
        ...
        :param pulumi.Input[builtins.str] sync_mode: The default sync mode to use for all mappers attached to this identity provider. Can be once of `IMPORT`, `FORCE`, or `LEGACY`.
        ...
        :param pulumi.Input[builtins.bool] ui_locales: Pass current locale to identity provider. Defaults to `false`.
        :param pulumi.Input[builtins.str] user_info_url: User Info URL.
        :param pulumi.Input[builtins.bool] validate_signature: Enable/disable signature validation of external IDP signatures. Defaults to `false`.
        """
    ...
    def authorization_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authorization_url(self, value: pulumi.Input[builtins.str]):
    ...
    def accepts_prompt_none_forward_from_client(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def accepts_prompt_none_forward_from_client(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def disable_user_info(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ui_locales(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @ui_locales.setter
    def ui_locales(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class IdentityProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ui_locales: Optional[pulumi.Input[builtins.bool]] = None,
            user_info_url: Optional[pulumi.Input[builtins.str]] = None,
            validate_signature: Optional[pulumi.Input[builtins.bool]] = None) -> 'IdentityProvider':
        """
    ...
    @property
    @pulumi.getter(name="acceptsPromptNoneForwardFromClient")
    def accepts_prompt_none_forward_from_client(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, the IDP will accept forwarded authentication requests that contain the `prompt=none` query parameter. Defaults to `false`.
        """
        return pulumi.get(self, "accepts_prompt_none_forward_from_client")
    ...
    @property
    @pulumi.getter(name="defaultScopes")
    def default_scopes(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The scopes to be sent when asking for authorization. It can be a space-separated list of scopes. Defaults to `openid`.
        """
        return pulumi.get(self, "default_scopes")
    ...
    @property
    @pulumi.getter(name="disableUserInfo")
    def disable_user_info(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, disables the usage of the user info service to obtain additional user information. Defaults to `false`.
        """
        return pulumi.get(self, "disable_user_info")
    ...
    @property
    @pulumi.getter(name="uiLocales")
    def ui_locales(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Pass current locale to identity provider. Defaults to `false`.
        """
        return pulumi.get(self, "ui_locales")
    ...
    @property
    @pulumi.getter(name="userInfoUrl")
    def user_info_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        User Info URL.
        """
        return pulumi.get(self, "user_info_url")
