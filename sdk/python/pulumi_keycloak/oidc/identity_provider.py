...
class IdentityProviderArgs:
    def __init__(__self__, *,
                 ...
                 ui_locales: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] token_url: The Token URL.
        ...
        :param pulumi.Input[_builtins.str] issuer: The issuer identifier for the issuer of the response. If not provided, no validation will be performed.
        :param pulumi.Input[_builtins.str] jwks_url: JSON Web Key Set URL.
        ...
        :param pulumi.Input[_builtins.str] login_hint: Pass login hint to identity provider.
        :param pulumi.Input[_builtins.str] logout_url: The Logout URL is the end session endpoint to use to sign-out the user from external identity provider.
        ...
        :param pulumi.Input[_builtins.bool] org_redirect_mode_email_matches: Indicates whether to automatically redirect user to this identity provider when email domain matches domain.
        ...
        :param pulumi.Input[_builtins.str] provider_id: The ID of the identity provider to use. Defaults to `oidc`, which should be used unless you have extended Keycloak and provided your own implementation.
        ...
        :param pulumi.Input[_builtins.bool] ui_locales: Pass current locale to identity provider. Defaults to `false`.
        :param pulumi.Input[_builtins.str] user_info_url: User Info URL.
        :param pulumi.Input[_builtins.bool] validate_signature: Enable/disable signature validation of external IDP signatures. Defaults to `false`.
        """
    ...
    def authorization_url(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def authorization_url(self, value: pulumi.Input[_builtins.str]):
    ...
    def disable_type_claim_check(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def disable_type_claim_check(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def ui_locales(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    @ui_locales.setter
    def ui_locales(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class IdentityProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ui_locales: pulumi.Input[Optional[_builtins.bool]] = None,
            user_info_url: pulumi.Input[Optional[_builtins.str]] = None,
            validate_signature: pulumi.Input[Optional[_builtins.bool]] = None) -> 'IdentityProvider':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="disableTypeClaimCheck")
    def disable_type_claim_check(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When `true`, disables the check for the `typ` claim of tokens received from the identity provider. Defaults to `false`.
        """
        return pulumi.get(self, "disable_type_claim_check")
    ...
    @_builtins.property
    @pulumi.getter(name="uiLocales")
    def ui_locales(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Pass current locale to identity provider. Defaults to `false`.
        """
        return pulumi.get(self, "ui_locales")
    ...
    @_builtins.property
    @pulumi.getter(name="userInfoUrl")
    def user_info_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        User Info URL.
        """
        return pulumi.get(self, "user_info_url")
