...
class GoogleIdentityProviderArgs:
    def __init__(__self__, *,
                 ...
                 request_refresh_token: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 use_user_ip_param: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] request_refresh_token: Sets the "access_type" query parameter to "offline" when redirecting to google authorization endpoint,to get a refresh token back. This is useful for using Token Exchange to retrieve a Google token to access Google APIs when the user is offline.
        ...
        :param pulumi.Input[_builtins.bool] use_user_ip_param: Sets the "userIp" query parameter when querying Google's User Info service. This will use the user's IP address. This is useful if Google is throttling Keycloak's access to the User Info service.
        """
    ...
    def hosted_domain(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def hosted_domain(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def request_refresh_token(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def request_refresh_token(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def use_user_ip_param(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def use_user_ip_param(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class GoogleIdentityProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sync_mode: pulumi.Input[Optional[_builtins.str]] = None,
            trust_email: pulumi.Input[Optional[_builtins.bool]] = None,
            use_user_ip_param: pulumi.Input[Optional[_builtins.bool]] = None) -> 'GoogleIdentityProvider':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="hostedDomain")
    def hosted_domain(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Sets the "hd" query parameter when logging in with Google. Google will only list accounts for this domain. Keycloak will validate that the returned identity token has a claim for this domain. When `*` is entered, an account from any domain can be used.
        """
        return pulumi.get(self, "hosted_domain")
    ...
    @_builtins.property
    @pulumi.getter(name="requestRefreshToken")
    def request_refresh_token(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Sets the "access_type" query parameter to "offline" when redirecting to google authorization endpoint,to get a refresh token back. This is useful for using Token Exchange to retrieve a Google token to access Google APIs when the user is offline.
        """
        return pulumi.get(self, "request_refresh_token")
    ...
    @_builtins.property
    @pulumi.getter(name="useUserIpParam")
    def use_user_ip_param(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Sets the "userIp" query parameter when querying Google's User Info service. This will use the user's IP address. This is useful if Google is throttling Keycloak's access to the User Info service.
        """
        return pulumi.get(self, "use_user_ip_param")
