...
class ExecutionConfigArgs:
    ...
    def execution_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @execution_id.setter
    def execution_id(self, value: pulumi.Input[builtins.str]):
...
class _ExecutionConfigState:
    def __init__(__self__, *,
                 ...
                 execution_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="executionId")
    def execution_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The authentication execution this configuration is attached to.
        """
        return pulumi.get(self, "execution_id")
    ...
    @execution_id.setter
    def execution_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "execution_id", value)
...
class ExecutionConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            execution_id: Optional[pulumi.Input[builtins.str]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ExecutionConfig':
        """
    ...
    @property
    @pulumi.getter(name="executionId")
    def execution_id(self) -> pulumi.Output[builtins.str]:
        """
        The authentication execution this configuration is attached to.
        """
        return pulumi.get(self, "execution_id")
