...
class UserAttributeProtocolMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_attribute: The custom user attribute to map.
    ...
    def user_attribute(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def user_attribute(self, value: pulumi.Input[_builtins.str]):
...
class UserAttributeProtocolMapper(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        $ pulumi import keycloak:saml/userAttributeProtocolMapper:UserAttributeProtocolMapper saml_user_attribute_mapper my-realm/client/a7202154-8793-4656-b655-1dd18c181e14/name/my%20protocol%20mapper
        $ pulumi import keycloak:saml/userAttributeProtocolMapper:UserAttributeProtocolMapper saml_user_attribute_mapper my-realm/client-scope/b799ea7e-73ee-4a73-990a-1eafebe8e20a/name/my%20protocol%20mapper
        ```
    ...
    @_builtins.property
    @pulumi.getter(name="aggregateAttributes")
    def aggregate_attributes(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Indicates whether this attribute is a single value or an array of values. Defaults to `false`.
        """
        return pulumi.get(self, "aggregate_attributes")
