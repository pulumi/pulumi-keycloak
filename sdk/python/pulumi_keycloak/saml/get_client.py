...
class GetClientResult:
    ...
    def encrypt_assertions(self) -> builtins.bool:
    ...
    def include_authn_statement(self) -> builtins.bool:
    ...
    def sign_assertions(self) -> builtins.bool:
        return pulumi.get(self, "sign_assertions")

    @property
    @pulumi.getter(name="signDocuments")
    def sign_documents(self) -> builtins.bool:
