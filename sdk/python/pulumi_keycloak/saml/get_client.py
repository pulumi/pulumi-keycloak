...
class GetClientResult:
    ...
    def canonicalization_method(self) -> _builtins.str:
    ...
    def client_signature_required(self) -> _builtins.bool:
    ...
    def signature_key_name(self) -> _builtins.str:
...
def get_client_output(client_id: Optional[pulumi.Input[_builtins.str]] = None,
