...
class UserPropertyProtocolMapperArgs:
    def __init__(__self__, *,
                 ...
                 user_property: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] saml_attribute_name: The name of the SAML attribute.
        :param pulumi.Input[_builtins.str] saml_attribute_name_format: The SAML attribute Name Format. Can be one of `Unspecified`, `Basic`, or `URI Reference`.
        :param pulumi.Input[_builtins.str] user_property: The property of the Keycloak user model to map.
        ...
        :param pulumi.Input[_builtins.str] friendly_name: An optional human-friendly name for this attribute.
    ...
    def saml_attribute_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def saml_attribute_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "saml_attribute_name", value)

    @_builtins.property
    @pulumi.getter(name="samlAttributeNameFormat")
    def saml_attribute_name_format(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def saml_attribute_name_format(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "saml_attribute_name_format", value)

    @_builtins.property
    @pulumi.getter(name="userProperty")
    def user_property(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def user_property(self, value: pulumi.Input[_builtins.str]):
...
class _UserPropertyProtocolMapperState:
    def __init__(__self__, *,
                 ...
                 user_property: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="userProperty")
    def user_property(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The property of the Keycloak user model to map.
        """
        return pulumi.get(self, "user_property")
    ...
    @user_property.setter
    def user_property(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "user_property", value)
...
class UserPropertyProtocolMapper(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        $ pulumi import keycloak:saml/userPropertyProtocolMapper:UserPropertyProtocolMapper saml_user_property_mapper my-realm/client/a7202154-8793-4656-b655-1dd18c181e14/name/my%20protocol%20mapper
        $ pulumi import keycloak:saml/userPropertyProtocolMapper:UserPropertyProtocolMapper saml_user_property_mapper my-realm/client-scope/b799ea7e-73ee-4a73-990a-1eafebe8e20a/name/my%20protocol%20mapper
        ```
    ...
    def get(resource_name: str,
            ...
            saml_attribute_name: pulumi.Input[Optional[_builtins.str]] = None,
            saml_attribute_name_format: pulumi.Input[Optional[_builtins.str]] = None,
            user_property: pulumi.Input[Optional[_builtins.str]] = None) -> 'UserPropertyProtocolMapper':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="samlAttributeName")
    def saml_attribute_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the SAML attribute.
        """
        return pulumi.get(self, "saml_attribute_name")
    ...
    @_builtins.property
    @pulumi.getter(name="samlAttributeNameFormat")
    def saml_attribute_name_format(self) -> pulumi.Output[_builtins.str]:
        """
        The SAML attribute Name Format. Can be one of `Unspecified`, `Basic`, or `URI Reference`.
        """
        return pulumi.get(self, "saml_attribute_name_format")
    ...
    @_builtins.property
    @pulumi.getter(name="userProperty")
    def user_property(self) -> pulumi.Output[_builtins.str]:
        """
        The property of the Keycloak user model to map.
        """
        return pulumi.get(self, "user_property")
