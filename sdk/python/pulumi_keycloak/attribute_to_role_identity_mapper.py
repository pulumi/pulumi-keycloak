...
class AttributeToRoleIdentityMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role: Role Name.
        :param pulumi.Input[builtins.str] attribute_friendly_name: Attribute Friendly Name. Conflicts with `attribute_name`.
        :param pulumi.Input[builtins.str] attribute_name: Attribute Name.
        :param pulumi.Input[builtins.str] attribute_value: Attribute Value.
        :param pulumi.Input[builtins.str] claim_name: OIDC Claim Name
        :param pulumi.Input[builtins.str] claim_value: OIDC Claim Value
...
@pulumi.type_token("keycloak:index/attributeToRoleIdentityMapper:AttributeToRoleIdentityMapper")
class AttributeToRoleIdentityMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            realm: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'AttributeToRoleIdentityMapper':
        """
    ...
    @property
    @pulumi.getter(name="claimValue")
    def claim_value(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        OIDC Claim Value
        """
        return pulumi.get(self, "claim_value")
