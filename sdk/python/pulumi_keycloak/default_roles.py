...
class DefaultRolesArgs:
    def __init__(__self__, *,
                 default_roles: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 realm_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DefaultRoles resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] default_roles: Realm level roles assigned to new users by default.
    ...
    def default_roles(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def default_roles(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _DefaultRolesState:
    def __init__(__self__, *,
                 default_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="defaultRoles")
    def default_roles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Realm level roles assigned to new users by default.
        """
        return pulumi.get(self, "default_roles")
    ...
    @default_roles.setter
    def default_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "default_roles", value)
...
class DefaultRoles(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            default_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DefaultRoles':
        """
    ...
    @property
    @pulumi.getter(name="defaultRoles")
    def default_roles(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Realm level roles assigned to new users by default.
        """
        return pulumi.get(self, "default_roles")
