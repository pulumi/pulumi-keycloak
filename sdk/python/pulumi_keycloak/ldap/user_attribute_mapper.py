...
class UserAttributeMapperArgs:
    def __init__(__self__, *,
                 ...
                 attribute_force_default: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] attribute_force_default: When `true`, an empty default value is forced for mandatory attributes even when a default value is not specified. Defaults to `true`.
    ...
    def attribute_force_default(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def attribute_force_default(self, value: Optional[pulumi.Input[bool]]):
...
class UserAttributeMapper(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="attributeForceDefault")
    def attribute_force_default(self) -> pulumi.Output[Optional[bool]]:
        """
        When `true`, an empty default value is forced for mandatory attributes even when a default value is not specified. Defaults to `true`.
        """
        return pulumi.get(self, "attribute_force_default")
