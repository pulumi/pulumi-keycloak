...
class UserAttributeMapperArgs:
    def __init__(__self__, *,
                 ldap_attribute: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] user_model_attribute: Name of the user property or attribute you want to map the LDAP attribute into.
        ...
        :param pulumi.Input[_builtins.bool] is_binary_attribute: Should be true for binary LDAP attributes.
        :param pulumi.Input[_builtins.bool] is_mandatory_in_ldap: When `true`, this attribute must exist in LDAP. Defaults to `false`.
        :param pulumi.Input[_builtins.str] name: Display name of this mapper when displayed in the console.
        :param pulumi.Input[_builtins.bool] read_only: When `true`, this attribute is not saved back to LDAP when the user attribute is updated in Keycloak. Defaults to `false`.
        """
    ...
    def ldap_attribute(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def ldap_attribute(self, value: pulumi.Input[_builtins.str]):
    ...
    def user_model_attribute(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def user_model_attribute(self, value: pulumi.Input[_builtins.str]):
...
class UserAttributeMapper(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="alwaysReadValueFromLdap")
    def always_read_value_from_ldap(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When `true`, the value fetched from LDAP will override the value stored in Keycloak. Defaults to `false`.
        """
        return pulumi.get(self, "always_read_value_from_ldap")
    ...
    @_builtins.property
    @pulumi.getter(name="attributeDefaultValue")
    def attribute_default_value(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Default value to set in LDAP if `is_mandatory_in_ldap` is true and the value is empty.
        """
        return pulumi.get(self, "attribute_default_value")
    ...
    @_builtins.property
    @pulumi.getter(name="attributeForceDefault")
    def attribute_force_default(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When `true`, an empty default value is forced for mandatory attributes even when a default value is not specified. Defaults to `true`.
        """
        return pulumi.get(self, "attribute_force_default")
    ...
    @_builtins.property
    @pulumi.getter(name="isBinaryAttribute")
    def is_binary_attribute(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Should be true for binary LDAP attributes.
        """
        return pulumi.get(self, "is_binary_attribute")
    ...
    @_builtins.property
    @pulumi.getter(name="isMandatoryInLdap")
    def is_mandatory_in_ldap(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When `true`, this attribute must exist in LDAP. Defaults to `false`.
        """
        return pulumi.get(self, "is_mandatory_in_ldap")
    ...
    @_builtins.property
    @pulumi.getter(name="ldapAttribute")
    def ldap_attribute(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the mapped attribute on the LDAP object.
        """
        return pulumi.get(self, "ldap_attribute")
    ...
    @_builtins.property
    @pulumi.getter(name="userModelAttribute")
    def user_model_attribute(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the user property or attribute you want to map the LDAP attribute into.
        """
        return pulumi.get(self, "user_model_attribute")
