...
class HardcodedGroupMapper(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, group=None, ldap_user_federation_id=None, name=None, realm_id=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, group=None, ldap_user_federation_id=None, name=None, realm_id=None):
        """
