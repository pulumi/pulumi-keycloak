...
class FullNameMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ldap_full_name_attribute: The name of the LDAP attribute containing the user's full name.
        ...
        :param pulumi.Input[_builtins.bool] read_only: When `true`, updates to a user within Keycloak will not be written back to LDAP. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] write_only: When `true`, this mapper will only be used to write updates to LDAP. Defaults to `false`.
        """
    ...
    def ldap_full_name_attribute(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def ldap_full_name_attribute(self, value: pulumi.Input[_builtins.str]):
...
class FullNameMapper(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="ldapFullNameAttribute")
    def ldap_full_name_attribute(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the LDAP attribute containing the user's full name.
        """
        return pulumi.get(self, "ldap_full_name_attribute")
