...
class FullNameMapperArgs:
    def __init__(__self__, *,
                 ldap_full_name_attribute: pulumi.Input[builtins.str],
                 ...
                 write_only: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a FullNameMapper resource.
        :param pulumi.Input[builtins.str] ldap_full_name_attribute: The name of the LDAP attribute containing the user's full name.
        ...
        :param pulumi.Input[builtins.bool] read_only: When `true`, updates to a user within Keycloak will not be written back to LDAP. Defaults to `false`.
        :param pulumi.Input[builtins.bool] write_only: When `true`, this mapper will only be used to write updates to LDAP. Defaults to `false`.
        """
    ...
    def ldap_full_name_attribute(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ldap_full_name_attribute(self, value: pulumi.Input[builtins.str]):
    ...
    def write_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @write_only.setter
    def write_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _FullNameMapperState:
    def __init__(__self__, *,
                 ldap_full_name_attribute: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ldapFullNameAttribute")
    def ldap_full_name_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the LDAP attribute containing the user's full name.
        """
        return pulumi.get(self, "ldap_full_name_attribute")
    ...
    @ldap_full_name_attribute.setter
    def ldap_full_name_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_full_name_attribute", value)
...
@pulumi.type_token("keycloak:ldap/fullNameMapper:FullNameMapper")
class FullNameMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            read_only: Optional[pulumi.Input[builtins.bool]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None,
            write_only: Optional[pulumi.Input[builtins.bool]] = None) -> 'FullNameMapper':
        """
    ...
    @property
    @pulumi.getter(name="ldapFullNameAttribute")
    def ldap_full_name_attribute(self) -> pulumi.Output[builtins.str]:
        """
        The name of the LDAP attribute containing the user's full name.
        """
        return pulumi.get(self, "ldap_full_name_attribute")
    ...
    @property
    @pulumi.getter(name="writeOnly")
    def write_only(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When `true`, this mapper will only be used to write updates to LDAP. Defaults to `false`.
        """
        return pulumi.get(self, "write_only")
