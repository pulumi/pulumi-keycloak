...
class HardcodedAttributeMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] attribute_name: The name of the LDAP attribute to set.
        :param pulumi.Input[builtins.str] attribute_value: The value to set to the LDAP attribute. You can hardcode any value like 'foo'.
