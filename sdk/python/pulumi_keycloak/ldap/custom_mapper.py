...
class CustomMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] provider_id: The id of the LDAP mapper implemented in MapperFactory.
        :param pulumi.Input[builtins.str] provider_type: The fully-qualified Java class name of the custom LDAP mapper.
        :param pulumi.Input[builtins.str] realm_id: The realm that this LDAP mapper will exist in.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] config: A map with key / value pairs for configuring the LDAP mapper. The supported keys depend on the protocol mapper.
...
class CustomMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            provider_id: Optional[pulumi.Input[builtins.str]] = None,
            provider_type: Optional[pulumi.Input[builtins.str]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomMapper':
        """
