...
class UserFederationCacheArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] eviction_minute: Minute of day the entry will become invalid on.
        :param pulumi.Input[_builtins.str] max_lifespan: Max lifespan of cache entry (duration string).
        :param pulumi.Input[_builtins.str] policy: Can be one of `DEFAULT`, `EVICT_DAILY`, `EVICT_WEEKLY`, `MAX_LIFESPAN`, or `NO_CACHE`. Defaults to `DEFAULT`.
        """
...
class UserFederationKerberosArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] server_principal: The kerberos server principal, e.g. 'HTTP/host.foo.com@FOO.LOCAL'.
        :param pulumi.Input[_builtins.bool] use_kerberos_for_password_authentication: Use kerberos login module instead of ldap service api. Defaults to `false`.
        """
    ...
    def key_tab(self) -> pulumi.Input[_builtins.str]:
        """
        Path to the kerberos keytab file on the server with credentials of the service principal.
        """
    ...
    @key_tab.setter
    def key_tab(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "key_tab", value)

    @_builtins.property
    @pulumi.getter(name="serverPrincipal")
    def server_principal(self) -> pulumi.Input[_builtins.str]:
        """
        The kerberos server principal, e.g. 'HTTP/host.foo.com@FOO.LOCAL'.
        """
    ...
    def server_principal(self, value: pulumi.Input[_builtins.str]):
