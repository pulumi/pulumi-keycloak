...
class HardcodedAttributeMapperArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] attribute_name: The name of the user model attribute to set.
        :param pulumi.Input[_builtins.str] attribute_value: The value to set to model attribute. You can hardcode any value like 'foo'.
...
class HardcodedAttributeMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ldap_user_federation_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            realm_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'HardcodedAttributeMapper':
        """
