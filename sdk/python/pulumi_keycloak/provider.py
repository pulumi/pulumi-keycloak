...
class ProviderArgs:
    ...
    def initial_login(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def initial_login(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def red_hat_sso(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @red_hat_sso.setter
    def red_hat_sso(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "red_hat_sso", value)

    @property
    @pulumi.getter(name="rootCaCertificate")
    def root_ca_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def root_ca_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter
    def realm(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "realm")

    @property
    @pulumi.getter(name="rootCaCertificate")
    def root_ca_certificate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allows x509 calls using an unknown CA certificate (for development purposes)
        """
        return pulumi.get(self, "root_ca_certificate")
