...
class AttributeImporterIdentityProviderMapperArgs:
    def __init__(__self__, *,
                 ...
                 attribute_friendly_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] identity_provider_alias: The alias of the associated identity provider.
        :param pulumi.Input[builtins.str] realm: The name of the realm.
        :param pulumi.Input[builtins.str] user_attribute: The user attribute or property name to store the mapped result.
        :param pulumi.Input[builtins.str] attribute_friendly_name: For SAML based providers, this is the friendly name of the attribute to search for in the assertion. Conflicts with `attribute_name`.
        :param pulumi.Input[builtins.str] attribute_name: For SAML based providers, this is the name of the attribute to search for in the assertion. Conflicts with `attribute_friendly_name`.
        :param pulumi.Input[builtins.str] claim_name: For OIDC based providers, this is the name of the claim to use.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] extra_config: Key/value attributes to add to the identity provider mapper model that is persisted to Keycloak. This can be used to extend the base model with new Keycloak features.
        :param pulumi.Input[builtins.str] name: The name of the mapper.
        """
    ...
    def attribute_friendly_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def attribute_friendly_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("keycloak:index/attributeImporterIdentityProviderMapper:AttributeImporterIdentityProviderMapper")
class AttributeImporterIdentityProviderMapper(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            realm: Optional[pulumi.Input[builtins.str]] = None,
            user_attribute: Optional[pulumi.Input[builtins.str]] = None) -> 'AttributeImporterIdentityProviderMapper':
        """
    ...
    @property
    @pulumi.getter(name="attributeFriendlyName")
    def attribute_friendly_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        For SAML based providers, this is the friendly name of the attribute to search for in the assertion. Conflicts with `attribute_name`.
        """
        return pulumi.get(self, "attribute_friendly_name")
    ...
    @property
    @pulumi.getter(name="claimName")
    def claim_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        For OIDC based providers, this is the name of the claim to use.
        """
        return pulumi.get(self, "claim_name")
