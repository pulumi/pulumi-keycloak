...
class RealmOtpPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] algorithm: What hashing algorithm should be used to generate the OTP.
        :param pulumi.Input[str] type: OTP Type, totp for Time-Based One Time Password or hotp for counter base one time password
        """
