...
class GetRoleResult:
    ...
    def composite_roles(self) -> Sequence[_builtins.str]:
...
def get_role(client_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str client_id: When specified, this role is assumed to be a client role belonging to the client with the provided ID. The `id` attribute of a `keycloak_client` resource should be used here.
    :param _builtins.str name: The name of the role.
    :param _builtins.str realm_id: The realm this role exists within.
    """
    __args__ = dict()
...
def get_role_output(client_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
