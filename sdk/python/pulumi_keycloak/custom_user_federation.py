...
class CustomUserFederationArgs:
    def __init__(__self__, *,
                 ...
                 cache_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] provider_id: The unique ID of the custom provider, specified in the `getId` implementation for the `UserStorageProviderFactory` interface.
        :param pulumi.Input[builtins.str] realm_id: The realm that this provider will provide user federation for.
        :param pulumi.Input[builtins.str] cache_policy: Can be one of `DEFAULT`, `EVICT_DAILY`, `EVICT_WEEKLY`, `MAX_LIFESPAN`, or `NO_CACHE`. Defaults to `DEFAULT`.
        :param pulumi.Input[builtins.int] changed_sync_period: How frequently Keycloak should sync changed users, in seconds. Omit this property to disable periodic changed users sync.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] config: The provider configuration handed over to your custom user federation provider. In order to add multivalued settings, use `##` to separate the values.
        ...
        :param pulumi.Input[builtins.int] full_sync_period: How frequently Keycloak should sync all users, in seconds. Omit this property to disable periodic full sync.
        :param pulumi.Input[builtins.str] name: Display name of the provider when displayed in the console.
        :param pulumi.Input[builtins.str] parent_id: Must be set to the realms' `internal_id`  when it differs from the realm. This can happen when existing resources are imported into the state.
    ...
    def cache_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cache_policy.setter
    def cache_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomUserFederation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.int]] = None,
            provider_id: Optional[pulumi.Input[builtins.str]] = None,
            realm_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomUserFederation':
        """
    ...
    @property
    @pulumi.getter(name="cachePolicy")
    def cache_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Can be one of `DEFAULT`, `EVICT_DAILY`, `EVICT_WEEKLY`, `MAX_LIFESPAN`, or `NO_CACHE`. Defaults to `DEFAULT`.
        """
        return pulumi.get(self, "cache_policy")
