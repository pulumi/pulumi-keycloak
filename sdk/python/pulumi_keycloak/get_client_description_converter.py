...
class GetClientDescriptionConverterResult:
    ...
    @_builtins.property
    @pulumi.getter
    def access(self) -> Mapping[str, _builtins.str]:
    ...
    def bearer_only(self) -> _builtins.bool:
    ...
    def frontchannel_logout(self) -> _builtins.bool:
    ...
    def optional_client_scopes(self) -> Sequence[_builtins.str]:
    ...
    def public_client(self) -> _builtins.bool:
    ...
    def registered_nodes(self) -> Mapping[str, _builtins.str]:
        return pulumi.get(self, "registered_nodes")

    @_builtins.property
    @pulumi.getter(name="registrationAccessToken")
    def registration_access_token(self) -> _builtins.str:
    ...
    def surrogate_auth_required(self) -> _builtins.bool:
...
def get_client_description_converter(body: Optional[_builtins.str] = None,
    ...
    :param _builtins.str body: The body of the request to convert.
    :param _builtins.str realm_id: The realm to use for the client description converter API call.
    """
    __args__ = dict()
    __args__['body'] = body
